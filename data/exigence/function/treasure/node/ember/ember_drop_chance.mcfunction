...
# Proc drop chance
execute if data storage exigence:dungeon_settings {stacked_embers:0} run function exigence:treasure/node/coin/private/no_stack_chance
execute if data storage exigence:dungeon_settings {stacked_embers:1} run function exigence:treasure/node/coin/private/stack_chance

# Drop ember
execute if score @s Random matches 1 run function exigence:treasure/node/drop_treasure {priority:0,function:"exigence:ember/summon_ember"}

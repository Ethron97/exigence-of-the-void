...
scoreboard players operation pos.Y node.treasure.drop_working = @s node.property.treasure.BBY1
...
scoreboard players operation size.X node.treasure.drop_working = @s node.property.treasure.BBX2
scoreboard players operation size.X node.treasure.drop_working -= @s node.property.treasure.BBX1
scoreboard players add size.X node.treasure.drop_working 1

scoreboard players operation size.Y node.treasure.drop_working = @s node.property.treasure.BBY2
scoreboard players operation size.Y node.treasure.drop_working -= @s node.property.treasure.BBY1
scoreboard players add size.Y node.treasure.drop_working 1

scoreboard players operation size.Z node.treasure.drop_working = @s node.property.treasure.BBZ2
scoreboard players operation size.Z node.treasure.drop_working -= @s node.property.treasure.BBZ1
scoreboard players add size.Z node.treasure.drop_working 1

execute store result storage exigence:treasure_drop final_x int 1 run scoreboard players get @s node.property.treasure.BBX1
...
execute store result storage exigence:treasure_drop final_z int 1 run scoreboard players get @s node.property.treasure.BBZ1

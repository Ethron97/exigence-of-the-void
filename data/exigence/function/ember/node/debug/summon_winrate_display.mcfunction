# Summon debug display showing echo winrate
...
execute at @s positioned ~ ~2.31 ~ run function exigence:ember/node/debug/summon_winrate_display_macro with storage exigence:temp

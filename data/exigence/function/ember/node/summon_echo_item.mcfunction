...
# Spawn echo item
summon minecraft:item ~ ~1 ~ {Tags:["NewEcho","EchoShard","ETICK"],Item:{id:"minecraft:music_disc_relic",count:1\
,components:{"minecraft:custom_model_data":{"strings":["echo_shard"]}}},Invulnerable:1b}

...
$execute if data storage exigence:debug {ember:1} as @e[type=minecraft:item,scores={node.property.object_level=$(levels)},tag=Ember] run data modify entity @s Glowing set value true

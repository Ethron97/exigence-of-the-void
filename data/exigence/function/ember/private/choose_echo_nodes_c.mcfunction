...
$execute if score Difficulty DungeonRun matches 1.. run tag @e[type=minecraft:armor_stand,scores={EchoDifficulty=$(chosen_difficulty),ObjectLevel=$(level)},tag=EchoNode,sort=random,limit=1] add ChosenEchoNode

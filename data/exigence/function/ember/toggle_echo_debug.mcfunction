...
$execute if data storage exigence:debug {echo:1} as @e[type=minecraft:armor_stand,scores={ObjectLevel=$(levels)},tag=EchoNode] run data merge entity @s {Glowing:1b,CustomNameVisible:1b,Invisible:0b,Marker:0b}
...
$execute if data storage exigence:debug {echo:1} as @e[type=minecraft:armor_stand,scores={EchoDifficulty=0,ObjectLevel=$(levels)},tag=EchoNode] run team join Hazard @s
...
$execute if data storage exigence:debug {echo:1} as @e[type=minecraft:armor_stand,scores={ObjectLevel=$(levels)},tag=EchoNode] run function exigence:ember/private/summon_echo_difficulty_display
...
$execute if data storage exigence:debug {echo:1} as @e[type=minecraft:armor_stand,scores={ObjectLevel=$(levels)},tag=EchoNode] run function exigence:ember/private/summon_winrate_display

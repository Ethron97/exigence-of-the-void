...
execute at @e[type=minecraft:armor_stand,scores={node.property.object_level=3},tag=MenaceNode,tag=WitherSkeleton,sort=random,limit=1] run tp @e[type=minecraft:wither_skeleton,name=Decay] ~ ~ ~
...
execute at @e[type=minecraft:armor_stand,scores={node.property.object_level=3},tag=MenaceNode,tag=WitherSkeleton,sort=random,limit=1] run tp @e[type=minecraft:wither_skeleton,name=Rot] ~ ~ ~

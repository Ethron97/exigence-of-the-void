...
execute if score toggle.hub debug matches 1 if score debug.level debug matches 2.. run say (D2 Hub) Close ember shop (room expired)
...
if score @s player.node.room_id = #compare hub.room.room_id run function exigence:room/ember_shop/expire/try_kick_player

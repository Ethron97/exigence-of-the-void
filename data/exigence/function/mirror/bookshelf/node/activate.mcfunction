...
execute if entity @s[tag=FacingEast] run data modify storage exigence:bookshelf facing set value 'east'
execute if entity @s[tag=FacingWest] run data modify storage exigence:bookshelf facing set value 'west'
execute if entity @s[tag=FacingNorth] run data modify storage exigence:bookshelf facing set value 'north'
execute if entity @s[tag=FacingSouth] run data modify storage exigence:bookshelf facing set value 'south'

# Each slot has a 1/4 chance of being occupied
...
execute at @s run function exigence:mirror/bookshelf/node/activate_macro with storage exigence:bookshelf

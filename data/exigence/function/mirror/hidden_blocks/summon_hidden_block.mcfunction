...
# DEBUG
#$say Reflection$(reflection) $(mirror)

# Summon a new marker
$execute align x align y align z run summon minecraft:marker ~0.5 ~ ~0.5 {Duration:999999,Tags:["NewMarker","Marker","HiddenBlock","Reflection$(reflection)","$(mirror)"],CustomName:{text:"Marker | HiddenBlock"}}

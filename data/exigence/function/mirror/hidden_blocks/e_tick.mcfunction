...
execute if entity @s[tag=ReflectionYES,tag=Revealed] unless entity @e[type=minecraft:armor_stand,tag=Reflection,distance=..2] run function exigence:mirror/hidden_blocks/hide_block

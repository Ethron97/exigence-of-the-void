...
execute as @e[type=minecraft:item_display,scores={InsertingKey=60}] at @s run execute as @e[type=minecraft:item_display,tag=VaultHandleKey,distance=..1] run tp @s ^ ^ ^

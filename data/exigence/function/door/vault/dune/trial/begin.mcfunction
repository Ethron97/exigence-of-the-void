...
execute if entity @s[tag=Trial] as @a unless score @s game.player.vault_code matches 2 run title @s subtitle [{"selector":"@a[scores={game.player.vault_code=2}]",color:"yellow"},\
{text:" entered the ",color:"gray"},{text:"Trial of Dust",color:"aqua"}]
execute if entity @s[tag=Crucible] as @a unless score @s game.player.vault_code matches 2 run title @s subtitle [{"selector":"@a[scores={game.player.vault_code=2}]",color:"yellow"},\
{text:" entered the ",color:"gray"},{text:"Crucible of Dust",color:"light_purple"}]
execute as @a unless score @s game.player.vault_code matches 2 run title @s title ""
...
execute if data storage exigence:dungeon {is_active:1} run scoreboard players add @s[tag=Trial] profile.data.vaults.cr.dune_trial_try 1
execute if data storage exigence:dungeon {is_active:1} run scoreboard players add @s[tag=Crucible] profile.data.vaults.cr.dune_crucible_try 1

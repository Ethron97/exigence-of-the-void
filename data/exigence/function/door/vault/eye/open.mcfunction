...
execute as @e[type=minecraft:armor_stand,scores={game.node.node_state=0},tag=AltarNode,tag=Trial,tag=AltarTrialDisplay] at @s run function exigence:door/vault/eye/summon_trial_displays with entity @s

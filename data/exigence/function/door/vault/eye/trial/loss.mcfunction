...
execute if score toggle.trial debug matches 1 if score debug.level debug matches 3.. run say (D3 Trial) Eye trial loss

# Reset vault
execute at @s run function exigence:door/vault/eye/trial/reset

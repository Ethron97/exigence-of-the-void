...
tag @e[type=marker,tag=Spire,tag=NewSpire,sort=random,limit=3] add SpireSplit
...
# Create new spires
execute as @e[type=marker,scores={Random=1..},tag=Spire,tag=SpireSplit] run function exigence:door/vault/spire/trial/spire/create_falling
execute as @e[type=marker,scores={Random=2..},tag=Spire,tag=SpireSplit] run function exigence:door/vault/spire/trial/spire/create_falling

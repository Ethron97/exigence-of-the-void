...
execute as @a[scores={dead=0,game.player.vault_code=5},tag=ActivePlayer] at @s if block ~ ~-1 ~ minecraft:barrier run function exigence:door/vault/spire/trial/loss
execute as @a[scores={dead=0,game.player.vault_code=5},tag=ActivePlayer] if predicate exigence:player/on_fire run function exigence:door/vault/spire/trial/loss

# Detect win
#   If player survives 30 seconds, win. (600 ticks + 60 for pre-trial time)
execute if score Spire TrialTimer matches 660.. as @a[scores={dead=0,game.player.vault_code=5},tag=ActivePlayer] run function exigence:door/vault/spire/trial/win

# If player died somehow, loss
execute as @a[scores={dead=1,game.player.vault_code=5},tag=ActivePlayer] run function exigence:door/vault/spire/trial/loss
...
execute unless entity @a[scores={dead=0,game.player.vault_code=5},tag=ActivePlayer] run return 1
#----------------------------------------------------------------------------------------------------
...
execute if score Spire TrialTimer matches 20 as @a[scores={dead=0,game.player.vault_code=5},tag=ActivePlayer] run function exigence:door/vault/_trial/titles/2
execute if score Spire TrialTimer matches 40 as @a[scores={dead=0,game.player.vault_code=5},tag=ActivePlayer] run function exigence:door/vault/_trial/titles/1
execute if score Spire TrialTimer matches 60 as @a[scores={dead=0,game.player.vault_code=5},tag=ActivePlayer] run title @s subtitle {text:"Don't fall",color:"aqua"}
execute if score Spire TrialTimer matches 60 as @a[scores={dead=0,game.player.vault_code=5},tag=ActivePlayer] run title @s title ""
execute if score Spire TrialTimer matches 80 as @a[scores={dead=0,game.player.vault_code=5},tag=ActivePlayer] run function exigence:door/vault/_trial/titles/blank

# Almost there!
execute if score Spire TrialTimer matches 600 as @a[scores={dead=0,game.player.vault_code=5},tag=ActivePlayer] run function exigence:door/vault/_trial/titles/3
execute if score Spire TrialTimer matches 620 as @a[scores={dead=0,game.player.vault_code=5},tag=ActivePlayer] run function exigence:door/vault/_trial/titles/2
execute if score Spire TrialTimer matches 640 as @a[scores={dead=0,game.player.vault_code=5},tag=ActivePlayer] run function exigence:door/vault/_trial/titles/1
execute if score Spire TrialTimer matches 659 as @a[scores={dead=0,game.player.vault_code=5},tag=ActivePlayer] run function exigence:door/vault/_trial/titles/blank

...
execute as @a[tag=ActivePlayer,scores={dead=0,VaultCode=5}] at @s if block ~ ~-1 ~ minecraft:barrier run function exigence:door/vault/spire/trial/loss
execute as @a[tag=ActivePlayer,scores={dead=0,VaultCode=5}] if predicate exigence:player/on_fire run function exigence:door/vault/spire/trial/loss

# Detect win
#   If player survives 30 seconds, win. (600 ticks + 60 for pre-trial time)
execute if score Spire TrialTimer matches 660.. as @a[tag=ActivePlayer,scores={dead=0,VaultCode=5}] run function exigence:door/vault/spire/trial/win

# If player died somehow, loss
execute as @a[tag=ActivePlayer,scores={dead=1,VaultCode=5}] run function exigence:door/vault/spire/trial/loss
...
execute unless entity @a[tag=ActivePlayer,scores={dead=0,VaultCode=5}] run return 1
...
execute if score Spire TrialTimer matches 0 as @a[tag=ActivePlayer,scores={dead=0,VaultCode=5}] run function exigence:door/vault/_trial/titles/3
execute if score Spire TrialTimer matches 20 as @a[tag=ActivePlayer,scores={dead=0,VaultCode=5}] run function exigence:door/vault/_trial/titles/2
execute if score Spire TrialTimer matches 40 as @a[tag=ActivePlayer,scores={dead=0,VaultCode=5}] run function exigence:door/vault/_trial/titles/1
execute if score Spire TrialTimer matches 60 as @a[tag=ActivePlayer,scores={dead=0,VaultCode=5}] run title @s subtitle {text:"Don't fall",color:"aqua"}
execute if score Spire TrialTimer matches 60 as @a[tag=ActivePlayer,scores={dead=0,VaultCode=5}] run title @s title ""
execute if score Spire TrialTimer matches 80 as @a[tag=ActivePlayer,scores={dead=0,VaultCode=5}] run function exigence:door/vault/_trial/titles/blank

# Almost there!
execute if score Spire TrialTimer matches 600 as @a[tag=ActivePlayer,scores={dead=0,VaultCode=5}] run function exigence:door/vault/_trial/titles/3
execute if score Spire TrialTimer matches 620 as @a[tag=ActivePlayer,scores={dead=0,VaultCode=5}] run function exigence:door/vault/_trial/titles/2
execute if score Spire TrialTimer matches 640 as @a[tag=ActivePlayer,scores={dead=0,VaultCode=5}] run function exigence:door/vault/_trial/titles/1
execute if score Spire TrialTimer matches 659 as @a[tag=ActivePlayer,scores={dead=0,VaultCode=5}] run function exigence:door/vault/_trial/titles/blank
...
execute if score beat SpireTimer matches 0 unless score Cooldown SpireTimer matches 0 run playsound minecraft:block.note_block.basedrum ambient @a[scores={VaultCode=5}] ~ ~1000 ~ 1000 1

# When cooldown 0, proc next and reset score
execute if score Cooldown SpireTimer matches 0 run playsound minecraft:block.note_block.didgeridoo ambient @a[scores={VaultCode=5}] ~ ~1000 ~ 1000 1

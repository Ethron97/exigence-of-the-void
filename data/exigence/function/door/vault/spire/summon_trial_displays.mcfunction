...
$summon minecraft:text_display ^ ^2.5 ^-1.4 {background:1,line_width:150,Rotation:$(Rotation),Tags:["VaultTrialDisplay","NewVaultTrialDisplay"],billboard:'fixed',text:[{text:"Trial of Heights",color:"yellow"}]}
...
$execute positioned ^0.5 ^2 ^-1.2 run function exigence:door/vault/vault_item_display {menu_tag:'VaultDisplaySpire',item_name:'heighten',Rotation:'$(Rotation)'}

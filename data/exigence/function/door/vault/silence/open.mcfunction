...
execute as @e[type=minecraft:armor_stand,tag=AltarNode,tag=Trial,tag=AltarTrialDisplay,scores={NodeState=0}] at @s run function exigence:door/vault/silence/summon_trial_displays with entity @s

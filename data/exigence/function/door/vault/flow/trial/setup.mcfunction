...
summon minecraft:marker -355.5 152.00 -25.5 {Tags:["FlowTrialSetup","FlowCenter"],CustomName:{text:"Marker | FlowCenter"}}
summon minecraft:marker -355.5 152.00 -25.5 {Tags:["FlowTrialSetup","FlowPosA"],CustomName:{text:"Marker | FlowPosA"}}

...
execute if score toggle.trial debug matches 1 if score debug.level debug matches 3.. run say (D3 Trial) Flow trial loss

# Reset vault
execute at @s run function exigence:door/vault/flow/trial/reset

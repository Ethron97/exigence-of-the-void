...
# Setup new runes
execute as @e[type=minecraft:item_display,tag=NewRune,distance=..10] run function exigence:door/level/door_3/setup_handle_b

#====================================================================================================
# Summon enchanted barrier
summon minecraft:item_display ^ ^ ^0.1 {brightness:{block:15,sky:15},Rotation:[0.0f,0.0f],billboard:"fixed",Tags:["Door","Door3","DoorShimmer","Door3Shimmer"],\

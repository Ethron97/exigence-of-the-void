...
# DEBUG
execute if score toggle.door debug matches 1 if score debug.level debug matches 3.. run say (D3) Inserting DOOR 3 key

## HANDLE
#====================================================================================================
# Playsound
playsound minecraft:entity.breeze.idle_air ambient @a ~ ~ ~ 1 1

# Initialize score
scoreboard players set Door.3 game.door.inserting_key 81
...
$summon minecraft:item_display ^ ^1 ^0.5 {teleport_duration:20,Rotation:[$(rot0).0f,$(rot1).0f]\
,billboard:"fixed",Tags:["Door","Door3","DoorHandleKey","NewDoorHandleKey","Door3HandleKey"],CustomName:{text:"ItemDisplay | Door3HandleKey"}\

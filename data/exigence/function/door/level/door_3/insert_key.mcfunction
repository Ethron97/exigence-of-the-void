...
$execute at @a[tag=HandleInteracting] run summon item_display ^ ^1 ^0.5 {teleport_duration:20,Rotation:[$(rot0).0f,$(rot1).0f],billboard:"fixed",Tags:["Door","Door3","DoorHandleKey","NewDoorHandleKey","Door3HandleKey"],item:{id:"minecraft:trial_key",count:1,"components":{"minecraft:custom_model_data":{"strings":["level_3_key"]}}},transformation:[-0.0000f,-0.0000f,0.5000f,0.0000f,-0.5000f,-0.0000f,-0.0000f,0.0000f,0.0000f,-0.5000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f]}

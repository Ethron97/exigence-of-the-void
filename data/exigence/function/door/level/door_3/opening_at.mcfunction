...
execute if score Door.3 game.door.inserting_key matches 61 run execute as @e[type=minecraft:item_display,tag=Door3HandleKey,distance=..1] run data modify entity @s teleport_duration set value 10
execute if score Door.3 game.door.inserting_key matches 60 run execute as @e[type=minecraft:item_display,tag=Door3HandleKey,distance=..1] run tp @s ^ ^ ^-0.125
...
# Key turning begins
#   Rotate key
execute if score Door.3 game.door.inserting_key matches 41 run execute as @e[type=minecraft:item_display,tag=Door3HandleKey,distance=..1] run data modify entity @s interpolation_duration set value 30
execute if score Door.3 game.door.inserting_key matches 40 run execute as @e[type=minecraft:item_display,tag=Door3HandleKey,distance=..1] run data merge entity @s {start_interpolation:-1,transformation:[0.5000f,0.0000f,0.0000f,0.0000f,0.0000f,-0.0000f,0.5000f,0.0000f,0.0000f,-0.5000f,-0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f]}

#   Rotate slot with key
execute if score Door.3 game.door.inserting_key matches 41 run execute as @e[type=minecraft:item_display,tag=Door3Handle,distance=..1] run data modify entity @s interpolation_duration set value 30
...
execute if score Door.3 game.door.inserting_key matches 40 run execute as @e[type=minecraft:item_display,tag=Ring3,distance=..10] at @s run rotate @s ~ -90
execute if score Door.3 game.door.inserting_key matches 40 run execute as @e[type=minecraft:item_display,tag=Ring2,distance=..10] at @s run rotate @s ~ 90
execute if score Door.3 game.door.inserting_key matches 40 run execute as @e[type=minecraft:item_display,tag=Ring1,distance=..10] at @s run rotate @s ~ -90

# Start beacon sounds
execute if score Door.3 game.door.inserting_key matches 40 run playsound block.beacon.activate neutral @a ~ ~ ~ 1 1.1

# Rune ring effects
execute if score Door.3 game.door.inserting_key matches 30 run execute as @e[type=minecraft:item_display,tag=Ring1,distance=..10] run data modify entity @s Glowing set value true
...
execute if score Door.3 game.door.inserting_key matches 20 run execute as @e[type=minecraft:item_display,tag=Ring2,distance=..10] run data modify entity @s Glowing set value true
...
execute if score Door.3 game.door.inserting_key matches 11 run execute as @e[type=minecraft:item_display,tag=Ring3,distance=..10] run data modify entity @s Glowing set value true

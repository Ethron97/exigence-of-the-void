...
# Rune ring effects
execute if score Door.3 game.door.inserting_key matches 30 run execute as @e[type=item_display,tag=Ring1,distance=..10] run data modify entity @s Glowing set value true
...
execute if score Door.3 game.door.inserting_key matches 20 run execute as @e[type=item_display,tag=Ring2,distance=..10] run data modify entity @s Glowing set value true
...
execute if score Door.3 game.door.inserting_key matches 11 run execute as @e[type=item_display,tag=Ring3,distance=..10] run data modify entity @s Glowing set value true

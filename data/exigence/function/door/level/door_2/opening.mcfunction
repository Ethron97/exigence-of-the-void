...
execute in minecraft:overworld positioned -384.5 132.0 -90.0 at @n[type=minecraft:item_display,tag=Door2Handle,distance=..10] run function exigence:door/level/door_2/opening_at

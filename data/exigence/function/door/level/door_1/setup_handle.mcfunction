...
#summon item_display ^ ^0.25 ^-0.109375 {brightness:{block:15,sky:15},Rotation:[135.0f,0.0f],billboard:"fixed",Tags:["Door","Door1"],\

summon item_display ^ ^0.25 ^-0.171875 {brightness:{block:15,sky:15},Rotation:[135.0f,0.0f],billboard:"fixed",Tags:["Door","Door1"],\
...
summon item_display ^ ^ ^-0.125 {brightness:{block:15,sky:15},Rotation:[135.0f,0.0f],billboard:"fixed",Tags:["Door","Door1"],\
...
summon item_display ^ ^ ^-0.0625 {brightness:{block:15,sky:15},Rotation:[135.0f,0.0f],billboard:"fixed",Tags:["Door","Door1"],\
item:{id:"minecraft:nether_brick",count:1,components:{"minecraft:custom_model_data":{"strings":["door_lock_a"]}}},\
transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.0f,1.0f,1.0f]}}

# Central key slot that turns with the key
summon item_display ^ ^ ^ {brightness:{block:15,sky:15},Rotation:[135.0f,0.0f],billboard:"fixed",Tags:["Door","Door1","DoorHandle","NewDoorHandle","Door1Handle"],\
...
summon item_display ^ ^ ^ {brightness:{block:15,sky:15},Rotation:[135.0f,0.0f],billboard:"fixed",Tags:["Door","Door1"],\
item:{id:"minecraft:nether_brick",count:1,components:{"minecraft:custom_model_data":{"strings":["door_lock_c"]}}},\
transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.0f,1.0f,1.0f]}}

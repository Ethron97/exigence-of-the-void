...
execute in minecraft:overworld positioned -331.5 21.0 -257.5 at @n[type=minecraft:item_display,tag=Door1Handle,distance=..10] run function exigence:door/level/door_1/opening_at

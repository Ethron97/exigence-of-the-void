...
execute if data storage exigence:debug {altar:1} run function exigence:altar/admin/toggle_altar_debug {levels:'1..4'}
execute if data storage exigence:debug {beacon:1} run function exigence:beacon/toggle_beacon_debug {levels:'1..4'}
execute if data storage exigence:debug {bell:1} run function exigence:bell/admin/toggle_bell_debug {levels:'1..4'}
execute if data storage exigence:debug {berry:1} run function exigence:botany/admin/toggle_berry_debug {levels:'1..4'}
execute if data storage exigence:debug {bookshelf:1} run function exigence:mirror/bookshelf/admin/toggle_bookshelf_debug {levels:'1..4'}
execute if data storage exigence:debug {door:1} run function exigence:door/admin/toggle_door_debug {levels:'1..4'}
execute if data storage exigence:debug {echo:1} run function exigence:ember/admin/toggle_echo_debug {levels:'1..4'}
execute if data storage exigence:debug {enemy:1} run function exigence:enemy/toggle_enemy_debug {levels:'1..4'}
execute if data storage exigence:debug {hazard:1} run function exigence:hazard/admin/toggle_hazard_debug {levels:'1..4'}
execute if data storage exigence:debug {menace:1} run function exigence:menace/admin/toggle_menace_debug {levels:'1..4'}
execute if data storage exigence:debug {mirror:1} run function exigence:mirror/toggle_mirror_debug {levels:'1..4'}
execute if data storage exigence:debug {treasure:1} run function exigence:treasure/admin/toggle_treasure_debug {levels:'1..4'}
execute if data storage exigence:debug {variance:1} run function exigence:variance/admin/toggle_variance_debug {levels:'1..4'}

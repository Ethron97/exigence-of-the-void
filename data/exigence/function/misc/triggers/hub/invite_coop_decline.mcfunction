...
execute if entity @s[tag=Invited,tag=!Joined] in exigence:hub positioned 999 128 6 as @e[type=item_display,tag=PlayerHeadDisplay,distance=..300] if score @s IDID = #compare hub.player_entity.query_idid \

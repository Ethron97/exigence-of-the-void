...
execute if entity @s[tag=Invited,tag=!Joined] in exigence:hub as @e[x=-98,y=0,z=798,dx=244,dy=256,dz=16,type=minecraft:item_display,tag=PlayerHeadDisplay] if score @s IDID = #compare hub.player_entity.query_idid \

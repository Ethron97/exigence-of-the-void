# Update bar value of Silence trial

# 30 seconds = 600 ticks, bossbar is %100 so bossbar = ticks/6
scoreboard players operation #UpdateBarVal tick_counter = Silence TrialTimer
...
data modify storage exigence:bossbar name set value 'trial_silence'

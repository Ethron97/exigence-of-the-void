...
execute if score game.difficulty game.state matches 2.. if score 1.opened game.level_doors matches 0 if score 1.got_key game.level_doors matches 0 run data modify storage exigence:objective level_1 append value [{sprite:"exigence:item/level_1_key",atlas:"items",color:"white"}]
...
# BEACONS/ARDOR
#   If difficulty 5
execute if score game.difficulty game.state matches 5 run function exigence:bossbar/objective/level_1/ardor

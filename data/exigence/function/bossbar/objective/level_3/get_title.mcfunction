...
execute if score game.difficulty game.state matches 4.. if score 3.opened game.level_doors matches 0 if score 3.reached game.level_doors matches 1 if score 3.got_key game.level_doors matches 0 run data modify storage exigence:objective level_3 append value [{sprite:"exigence:item/level_3_key",atlas:"items",color:"white"}]

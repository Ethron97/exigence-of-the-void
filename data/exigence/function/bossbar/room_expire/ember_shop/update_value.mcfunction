...
data modify storage exigence:bossbar name set value 'expire_ember_shop'
function exigence:bossbar/update_bar_macro with storage exigence:bossbar

# Update name
bossbar set exigence:expire_ember_shop name [{text:"This room will forcibly close in ",color:"red"},{score:{name:"#bossbar",objective:"Temp"},color:"gold"},{text:" seconds",color:"red"}]

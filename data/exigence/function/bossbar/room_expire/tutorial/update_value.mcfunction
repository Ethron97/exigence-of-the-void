...
data modify storage exigence:bossbar name set value 'expire_tutorial'
function exigence:bossbar/update_bar_macro with storage exigence:bossbar

# Update name
bossbar set exigence:expire_tutorial name [{text:"This room will forcibly close in ",color:"red"},{score:{name:"#bossbar",objective:"Temp"},color:"gold"},{text:" seconds",color:"red"}]

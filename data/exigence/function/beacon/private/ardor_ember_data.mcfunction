...
execute if score @s game.entity.object_level matches 1 run data modify entity @s Item.components."minecraft:custom_model_data" set value {strings:["ardor_ember_1"]}
execute if score @s game.entity.object_level matches 2 run data modify entity @s Item.components."minecraft:custom_model_data" set value {strings:["ardor_ember_2"]}

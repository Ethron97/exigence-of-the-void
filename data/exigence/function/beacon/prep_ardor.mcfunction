...
# Reset scores
#   beacon.# = how many embers are deposited
...
#   ardor_embers.# = how many embers have been picked up
scoreboard players set ardor_embers.1 game.story.beacons 0
scoreboard players set ardor_embers.2 game.story.beacons 0
scoreboard players set ardor_embers.3 game.story.beacons 0
scoreboard players set ardor_embers.4 game.story.beacons 0

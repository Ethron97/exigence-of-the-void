$data merge entity @s {Item:{components:{"minecraft:custom_name":[$(name_cost),{text:"- Detection -",italic:false,bold:$(bold),color:"$(common)"}]},count:1,id:"minecraft:paper"}}
...
$data modify entity @s Item.components."minecraft:lore" append value [$(lore_cost),{text:": +30 seconds of ",italic:false,color:"gray",bold:false},{text:"Clairvoyance",italic:false,color:"$(effect)",bold:false}]

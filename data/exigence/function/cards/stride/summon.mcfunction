$data merge entity @s {Item:{components:{"minecraft:custom_name":[{text:"- Stride -",italic:false,bold:$(bold),color:"$(common)"}]},count:1,id:"minecraft:paper"}}
...
$data modify entity @s Item.components."minecraft:lore" append value [{text:"+60 seconds of ",italic:false,color:"gray"},{text:"Speed I",italic:false,color:"$(effect)"}]

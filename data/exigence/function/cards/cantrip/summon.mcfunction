$data merge entity @s {Item:{components:{"minecraft:custom_name":[$(name_cost),{text:"- Cantrip -",italic:false,color:"$(common)"}]},count:1,id:"minecraft:paper"}}
...
$data modify entity @s Item.components."minecraft:lore" append value [$(lore_cost),{text:": +1 ",bold:false,italic:false,color:"gray"},{text:"🧾",bold:false,italic:false,color:"$(spellbind)"},{text:" Common",bold:false,italic:false,color:"$(common)"}]

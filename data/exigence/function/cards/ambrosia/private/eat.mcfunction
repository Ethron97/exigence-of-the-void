...
#execute if score mod.ambrosia game.modifiers matches 1.. run function exigence:cards/ambrosia/private/random_effect
#execute if score mod.ambrosia game.modifiers matches 2.. run function exigence:cards/ambrosia/private/random_effect

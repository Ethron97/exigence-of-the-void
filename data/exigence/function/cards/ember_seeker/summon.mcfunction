$data merge entity @s {Item:{components:{"minecraft:custom_name":[{text:"- Ember Seeker -",italic:false,bold:$(bold),color:"$(common)"}]},count:1,id:"minecraft:paper"}}
...
data modify entity @s Item.components."minecraft:lore" append value [{text:"+2 ",italic:false,color:"gray"},{text:"🔥",italic:false,color:"aqua"}]

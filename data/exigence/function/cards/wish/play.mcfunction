...
execute if score random Random matches 1 run scoreboard players remove MaxGreen Resources 2
scoreboard players operation MaxGreen Resources > 0 number
...
execute if score random Random matches 2 run scoreboard players remove MaxRed Resources 2
scoreboard players operation MaxRed Resources > 0 number
...
execute if score random Random matches 3 run scoreboard players remove MaxAqua Resources 2
scoreboard players operation MaxAqua Resources > 0 number

$data merge entity @s {Item:{components:{"minecraft:custom_name":[{text:"✦ No Menace ✦",italic:false,color:"$(developer)"}]},count:1,id:"minecraft:paper"}}
...
data modify entity @s Item.components."minecraft:lore" append value [{text:"Start game with 999999 menace block",italic:false,color:"gray"}]

...
$data modify entity @s Item.components."minecraft:lore" append value [$(lore_cost),{text:": +4",bold:false,italic:false,color:"gray"},{text:" 🔥",bold:false,italic:false,color:"aqua"}]

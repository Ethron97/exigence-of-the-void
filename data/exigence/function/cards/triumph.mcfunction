...
# Elation (Speed)
execute if score tri.Elation game.triumph matches 1 as @a[scores={dead=0},tag=ActivePlayer] run function exigence:player/effects/speed/add_effect_time {level:2,duration:1200}
execute if score tri.Elation game.triumph matches 2 as @a[scores={dead=0},tag=ActivePlayer] run function exigence:player/effects/speed/add_effect_time {level:2,duration:2400}
execute if score tri.Elation game.triumph matches 3 as @a[scores={dead=0},tag=ActivePlayer] run function exigence:player/effects/speed/add_effect_time {level:2,duration:3600}

# Joy (jump, ie jumping for joy AHAHAHHAHAHAHAHAHAHHAHAHAHAHAHAHAHHAHAHAHAHAHAHAHAHAHHA send help)
execute if score tri.Joy game.triumph matches 1 as @a[scores={dead=0},tag=ActivePlayer] run function exigence:player/effects/add_effect_time {effect:"jump",duration:600}
execute if score tri.Joy game.triumph matches 2 as @a[scores={dead=0},tag=ActivePlayer] run function exigence:player/effects/add_effect_time {effect:"jump",duration:1200}
execute if score tri.Joy game.triumph matches 3 as @a[scores={dead=0},tag=ActivePlayer] run function exigence:player/effects/add_effect_time {effect:"jump",duration:1800}

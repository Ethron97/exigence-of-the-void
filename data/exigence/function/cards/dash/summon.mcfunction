$data merge entity @s {Item:{components:{"minecraft:custom_name":[$(name_cost),{text:"- Dash -",italic:false,bold:$(bold),color:"$(common)"}]},count:1,id:"minecraft:paper"}}
...
$data modify entity @s Item.components."minecraft:lore" append value [$(lore_cost),{text:": +60 seconds of ",bold:false,italic:false,color:"gray"},{text:"Speed II",bold:false,italic:false,color:"$(effect)"}]

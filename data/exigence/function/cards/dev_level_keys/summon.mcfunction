$data merge entity @s {Item:{components:{"minecraft:custom_name":[{text:"✦ Level Keys ✦",italic:false,color:"$(developer)"}]},count:1,id:"minecraft:paper"}}
...
data modify entity @s Item.components."minecraft:lore" append value [{text:"Start game with all keys",italic:false,color:"gray"}]

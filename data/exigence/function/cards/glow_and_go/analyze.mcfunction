...
scoreboard players add class.treasure.weighted deck.analysis 6
scoreboard players add class.ember deck.analysis 3
scoreboard players add class.ember.weighted deck.analysis 6
scoreboard players add class.movement deck.analysis 3
scoreboard players add class.movement.weighted deck.analysis 6

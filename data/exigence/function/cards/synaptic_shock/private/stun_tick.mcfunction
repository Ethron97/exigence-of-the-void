...
execute if score @s game.enemy.stun_timer matches ..1 unless entity @s[type=minecraft:ravager,scores={game.ravager.eating_cookie=2..}] run data modify entity @s NoAI set value false

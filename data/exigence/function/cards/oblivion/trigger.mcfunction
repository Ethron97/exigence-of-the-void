...
tag @e[type=minecraft:armor_stand,scores={deck.card.is_void=1},tag=Card] add ReturnCard
#   OLD FUNCTIONALITY
...
execute as @e[type=armor_stand,scores={deck.card.is_void=1},tag=Card] run scoreboard players add MinMenace DungeonRun 2

...
tag @e[type=minecraft:armor_stand,tag=Card,scores={IsVoid=1}] add ReturnCard
#   OLD FUNCTIONALITY
...
execute as @e[type=armor_stand,tag=Card,scores={IsVoid=1}] run scoreboard players add MinMenace DungeonRun 2

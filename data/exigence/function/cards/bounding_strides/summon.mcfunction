$data merge entity @s {Item:{components:{"minecraft:custom_name":[$(name_cost),{text:"- Bounding Strides -",italic:false,bold:$(bold),color:"$(uncommon)"}]},count:1,id:"minecraft:paper"}}
...
$data modify entity @s Item.components."minecraft:lore" append value [$(lore_cost),{text:": +1 minute of ",bold:false,italic:false,color:"gray"},{text:"Jump Boost II",bold:false,italic:false,color:"$(effect)"}]

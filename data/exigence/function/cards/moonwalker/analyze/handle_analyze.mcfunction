...
function exigence:cards/get_cost {card_name:'moonwalker'}

# Only add validation checks for resources actually used by this card
execute if score green.cost game.resources > resource.green.max deck.analysis run function exigence:deck/process/private/error/cost_too_great_m {display_name:'Moonwalker',resource:'green',resource_color:'dark_green',rarity_color:'light_purple'}

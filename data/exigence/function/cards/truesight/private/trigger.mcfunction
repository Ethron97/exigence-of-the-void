...
execute as @a[scores={dead=0,profile.data.effects.cr.effect_glimmer=1..},tag=ActivePlayer] run function exigence:cards/truesight/private/give_effect {effect:'glimmer',display:'Glimmer'}
execute as @a[scores={dead=0,profile.data.effects.cr.effect_flicker=1..},tag=ActivePlayer] run function exigence:cards/truesight/private/give_effect {effect:'flicker',display:'Flicker'}

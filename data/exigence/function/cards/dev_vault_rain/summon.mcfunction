$data merge entity @s {Item:{components:{"minecraft:custom_name":[{text:"✦ Vault Rain ✦",italic:false,color:"$(developer)"}]},count:1,id:"minecraft:paper"}}
...
data modify entity @s Item.components."minecraft:lore" append value [{text:"Vault keys have a 100% drop rate",italic:false,color:"gray"}]

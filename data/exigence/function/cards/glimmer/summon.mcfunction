$data merge entity @s {Item:{components:{"minecraft:custom_name":[$(name_cost),{text:"- Glimmer -",italic:false,bold:$(bold),color:"$(common)"}]},count:1,id:"minecraft:paper"}}
...
$data modify entity @s Item.components."minecraft:lore" append value [$(lore_cost),{text:": +1 minute of ",bold:false,italic:false,color:"gray"},\
{text:"Glimmer",bold:false,italic:false,color:"$(effect)"}]

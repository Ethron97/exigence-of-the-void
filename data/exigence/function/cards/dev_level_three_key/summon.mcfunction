$data merge entity @s {Item:{components:{"minecraft:custom_name":[{text:"✦ Level Three Key ✦",italic:false,color:"$(developer)"}]},count:1,id:"minecraft:paper"}}
...
data modify entity @s Item.components."minecraft:lore" append value [{text:"Start game with level 3 key",italic:false,color:"gray"}]

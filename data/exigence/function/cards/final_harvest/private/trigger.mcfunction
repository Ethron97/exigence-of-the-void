...
# Deactivate all non-grown active berry nodes
execute as @e[x=-520,y=-64,z=-287,dx=345,dy=345,dz=345,type=minecraft:marker,tag=BerryNode,tag=Active,tag=!Grown] run function exigence:botany/node/berry_bush_inactive

...
execute if score endermite.spawn.cooldown tick_counter matches ..0 at @e[type=minecraft:armor_stand,tag=VoidCache] run function exigence:cards/void_cache/private/spawn_endermite
...
# Particles
execute at @e[type=minecraft:armor_stand,tag=VoidCache] run particle dragon_breath ~ ~1 ~ 0.3 1 0.3 0.05 5

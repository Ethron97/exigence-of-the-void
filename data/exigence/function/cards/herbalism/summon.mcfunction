$data merge entity @s {Item:{components:{"minecraft:custom_name":[$(name_cost),{text:"- Herbalism -",italic:false,bold:$(bold),color:"$(common)"}]},count:1,id:"minecraft:paper"}}
...
$data modify entity @s Item.components."minecraft:lore" append value [$(lore_cost),{text:": +6 ",bold:false,italic:false,color:"gray"},{text:"🍪",bold:false,italic:false,color:"gold"}]

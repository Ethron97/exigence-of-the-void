...
execute in exigence:profile_data positioned 8 128 8 as @e[type=marker,tag=ProfileNode,distance=..1000] run scoreboard players operation #sequence profile.player.profile_id > @s profile.node.profile_id

...
as @e[distance=..140,type=marker,tag=ProfileNode] if score @s profile.node.player_id = #compare player.node.joined_player_1 \
...
as @e[distance=..140,type=marker,tag=ProfileNode] if score @s profile.node.player_id = #compare player.node.joined_player_2 \
run data modify storage exigence:temp invalid_identifiers append from entity @s data.custom_data.profile_identifier
...
as @e[distance=..140,type=marker,tag=ProfileNode] if score @s profile.node.player_id = #compare player.node.joined_player_3 \
run data modify storage exigence:temp invalid_identifiers append from entity @s data.custom_data.profile_identifier

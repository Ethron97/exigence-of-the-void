...
execute if score #room_type Temp matches 2 run say Loading chests to waiting PREDUNGEON
...
execute if score #room_type Temp matches 9 run say Loading chests to waiting ITEM SHOP

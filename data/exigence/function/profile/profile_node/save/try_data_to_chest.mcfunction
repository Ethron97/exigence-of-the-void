...
execute if score toggle.profile debug matches 1 if score debug.level debug matches 2.. run say (D2) Try data to chest
...
execute if score toggle.profile debug matches 1 if score debug.level debug matches 2.. run say (D2) Try data to chest pt2
...
execute if score toggle.profile debug matches 1 if score debug.level debug matches 2.. run say (D2) Check for waiting...
## CHECK FOR WAITING

...
execute positioned 1.5 1.0 2.5 as @e[distance=..1,type=marker,tag=NewPlayerNodeMarker] at @s run function exigence:profile/player_node/new/locate_next_player_slot
...
execute at @e[distance=..1000,type=marker,tag=NewPlayerNodeMarker] run function exigence:profile/player_node/new/summon_player_node

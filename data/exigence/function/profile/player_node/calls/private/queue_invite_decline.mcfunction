...
execute in exigence:hub as @e[x=-98,y=0,z=798,dx=244,dy=256,dz=16,type=text_display,tag=StatusDisplay] if score @s hub.entity.player_id = #compare profile.node.player_id \

...
execute in exigence:hub positioned 999 128 6 as @e[distance=..200,type=item_display,tag=CreationProcess] if score @s hub.entity.player_id = #compare hub.entity.player_id \

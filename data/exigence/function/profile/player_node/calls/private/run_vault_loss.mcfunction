...
# If the player has neither tag, they probably got kicked from the game first and we don't care about this
execute if entity @s[tag=!Game,tag=!Hub] run return 0
#----------------------------------------------------------------------------------------------------

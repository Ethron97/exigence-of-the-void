...
# Assign player id
execute as @e[distance=..1,type=minecraft:armor_stand,tag=NewPlayerNode] run scoreboard players operation @s profile.node.player_id = #sequence profile.player_id

...
# Level 0
#execute if score Cards.TotalCheck deck.analysis matches 2.. run data modify block -263 17 -77 front_text.messages[0] set value "Too many cards"

# Level 1
#   BUTTON
execute if score Cards.TotalCheck deck.analysis matches ..1 run setblock -263 18 -77 polished_blackstone_button[facing=south]
execute if score Cards.TotalCheck deck.analysis matches ..10 if entity @a[tag=Predungeon,advancements={exigence:story/win_difficulty_0=true}] run setblock -263 18 -77 polished_blackstone_button[facing=south]
#   TITLE SIGN
...
execute if score Cards.TotalCheck deck.analysis matches 11.. if entity @a[tag=Predungeon,advancements={exigence:story/win_difficulty_0=true}] run data modify block -263 17 -77 front_text.messages[0] set value "Too many cards"

# Level 2
#   BUTTON
execute if score Cards.TotalCheck deck.analysis matches ..20 if entity @a[tag=Predungeon,advancements={exigence:story/rescue_supplier=true}] run setblock -262 18 -77 polished_blackstone_button[facing=south]
#   TITLE SIGN
...
# Unlocked, but incorrect cards
execute if score Cards.TotalCheck deck.analysis matches 21.. if entity @a[tag=Predungeon,advancements={exigence:story/rescue_supplier=true}] run data modify block -262 17 -77 front_text.messages[0] set value "Too many cards"


# Level 3
#   BUTTON
execute if score Cards.TotalCheck deck.analysis matches ..30 if entity @a[tag=Predungeon,advancements={exigence:story/rescue_scientist=true}] run setblock -261 18 -77 polished_blackstone_button[facing=south]
#   TITLE SIGN
...
# Unlocked, but incorrect cards
execute if score Cards.TotalCheck deck.analysis matches 31.. if entity @a[tag=Predungeon,advancements={exigence:story/rescue_scientist=true}] run data modify block -261 17 -77 front_text.messages[0] set value "Too many cards"


# Level 4
#   BUTTON
execute if score Cards.TotalCheck deck.analysis matches ..40 if entity @a[tag=Predungeon,advancements={exigence:story/rescue_petitioner=true}] run setblock -260 18 -77 polished_blackstone_button[facing=south]
#   TITLE SIGN
...
# Unlocked, but incorrect cards
execute if score Cards.TotalCheck deck.analysis matches 41.. if entity @a[tag=Predungeon,advancements={exigence:story/rescue_petitioner=true}] run data modify block -260 17 -77 front_text.messages[0] set value "Too many cards"


# Level 5
#   BUTTON
execute if score Cards.TotalCheck deck.analysis matches ..40 if entity @a[tag=Predungeon,advancements={exigence:story/destroy_crystals=true}] run setblock -259 18 -77 polished_blackstone_button[facing=south]
#   TITLE SIGN
...
# Unlocked, but incorrect cards
execute if score Cards.TotalCheck deck.analysis matches 41.. if entity @a[tag=Predungeon,advancements={exigence:story/destroy_crystals=true}] run data modify block -259 17 -77 front_text.messages[0] set value "Too many cards"

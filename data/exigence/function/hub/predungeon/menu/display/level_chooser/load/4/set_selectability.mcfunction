...
# ATTEMPTED LEVEL:
execute if score #reached_4 Temp matches 1.. run tag @s add GoodKnown
...
execute if entity @s[tag=GoodUnlock] at @n[type=minecraft:marker,tag=DoorSlotMarker4,distance=..5] positioned ~-0.15625 ~ ~-0.0525 \

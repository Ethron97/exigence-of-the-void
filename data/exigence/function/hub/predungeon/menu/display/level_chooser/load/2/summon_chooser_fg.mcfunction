...
,Tags:["LevelChooserDisplayFG","MenuDisplay","NewItemDisplay","PredungeonDisplay","Level2","PredungeonMenuDisplay","A"]\
,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,1f,0f,0f],translation:[0f,0f,0f],scale:[0.5f,0.5f,0.5f]},CustomName:{text:"ItemDisplay | LevelChooserFG | 2"}\
...
# Default to locked
team join Red @n[type=item_display,tag=NewItemDisplay,distance=..0.1]

...
,Tags:["LevelChooserDisplay","MenuDisplay","NewItemDisplay","PredungeonDisplay","Level5","PredungeonMenuDisplay"]\
,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,1f,0f,0f],translation:[0f,0f,0f],scale:[0.5f,0.5f,1.0f]},CustomName:{text:"ItemDisplay | LevelChooser | 5"}\

...
# BEAT LEVEL:
execute if entity @p[distance=..16,tag=Predungeon,advancements={exigence:story/light_beacons=true}] run tag @s add GoodUnlock
...
data modify entity @s[tag=GoodUnlock] item.components."minecraft:custom_model_data".strings set value ["level_5"]

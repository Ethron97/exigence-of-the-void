...
execute if entity @p[distance=..16,tag=Predungeon,advancements={exigence:story/destroy_crystals=true}] run tag @s add GoodUnlock
...
execute at @s[tag=GoodUnlock,tag=GoodKnown,tag=!GoodCards] run function exigence:hub/predungeon/menu/display/level_chooser/load/5/model_locked
execute at @s[tag=GoodUnlock,tag=GoodKnown,tag=GoodCards] run function exigence:hub/predungeon/menu/display/level_chooser/load/5/model_available
...
execute if entity @s[tag=GoodUnlock] at @n[distance=..5,type=marker,tag=DoorSlotMarker5] positioned ~-0.15625 ~ ~-0.0525 \
run function exigence:hub/predungeon/menu/display/level_chooser/load/5/summon_deck_size
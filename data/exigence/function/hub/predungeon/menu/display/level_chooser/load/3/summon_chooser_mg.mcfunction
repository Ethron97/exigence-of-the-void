...
,Tags:["LevelChooserDisplayMG","NewItemDisplay","PredungeonDisplay","Level3","PredungeonMenuDisplay"]\
,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,1f,0f,0f],translation:[0f,0f,0f],scale:[0.5f,0.5f,0.5f]},CustomName:{text:"ItemDisplay | LevelChooserMG | 3"}\

...
,Tags:["LevelChooserDetails","NewTextDisplay","PredungeonDisplay","FromHover","LockedReasons"],text:{text:"Test"}\
,background:1,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0.0f,0.0f,0.0f],scale:[0.32f,0.32f,0.32f]}}
...
data modify entity @n[distance=..0.1,type=minecraft:text_display,tag=NewTextDisplay] text set from entity @s item.components."minecraft:lore"[1]

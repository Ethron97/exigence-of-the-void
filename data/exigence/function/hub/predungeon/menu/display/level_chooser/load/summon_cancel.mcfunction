...
,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,1f,0f,0f],translation:[-0.015625f,0f,0f],scale:[0.4f,0.4f,1.0f]},CustomName:{text:"ItemDisplay | Cancel"}\

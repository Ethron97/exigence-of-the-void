...
execute if score @s shop.player.looking_at_idid matches 1.. run data merge entity @n[type=interaction,tag=PredungeonInteraction,tag=CurrentCheckingInteraction,distance=..3] {width:1,height:1}

...
execute facing entity @p[tag=MeMeMe,distance=..16] eyes positioned ^ ^ ^0.15 as @n[type=minecraft:item_display,tag=PlayerSensorPupil,distance=..0.5] align z run tp @s ~ ~ ~0.82

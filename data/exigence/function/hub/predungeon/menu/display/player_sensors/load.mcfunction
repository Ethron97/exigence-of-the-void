...
# Update state
scoreboard players set predungeon.door_state hub.room_misc 2
...
execute if score #profile_size Temp matches 1 as @e[type=minecraft:item_display,tag=DoorSlotFill,tag=!DoorSlotFill0,tag=!Open,distance=..5,sort=random,limit=1] \
run function exigence:hub/predungeon/menu/display/player_sensors/load_player_sensor
execute if score #profile_size Temp matches 2 as @e[type=minecraft:item_display,tag=DoorSlotFill,tag=!DoorSlotFill0,tag=!Open,distance=..5,sort=random,limit=2] \
run function exigence:hub/predungeon/menu/display/player_sensors/load_player_sensor
execute if score #profile_size Temp matches 3 as @e[type=minecraft:item_display,tag=DoorSlotFill,tag=!DoorSlotFill0,tag=!Open,distance=..5,sort=random,limit=3] \
run function exigence:hub/predungeon/menu/display/player_sensors/load_player_sensor
execute if score #profile_size Temp matches 4 as @e[type=minecraft:item_display,tag=DoorSlotFill,tag=!DoorSlotFill0,tag=!Open,distance=..5,sort=random,limit=4] \
run function exigence:hub/predungeon/menu/display/player_sensors/load_player_sensor

...
execute if score #compare profile.player.profile_difficulty matches 1 run data modify entity @n[distance=..1,type=item_display,tag=NewItemDisplay] item.components."minecraft:custom_model_data".strings set value ["difficulty_radiant"]
execute if score #compare profile.player.profile_difficulty matches 2 run data modify entity @n[distance=..1,type=item_display,tag=NewItemDisplay] item.components."minecraft:custom_model_data".strings set value ["difficulty_ancient"]
execute if score #compare profile.player.profile_difficulty matches 3 run data modify entity @n[distance=..1,type=item_display,tag=NewItemDisplay] item.components."minecraft:custom_model_data".strings set value ["difficulty_ascendant"]
# TODO exigence

...
execute at @n[type=minecraft:marker,tag=DoorSlotMarker0,distance=..5] run \
...
execute at @n[type=minecraft:marker,tag=DoorSlotMarker1,distance=..5] run \
summon minecraft:item_display ~ ~ ~ {Rotation:[180.0f,0.0f],billboard:"fixed",interpolation_duration:3,teleport_duration:4\
...
execute at @n[type=minecraft:marker,tag=DoorSlotMarker2,distance=..5] run \
summon minecraft:item_display ~ ~ ~ {Rotation:[180.0f,0.0f],billboard:"fixed",interpolation_duration:3,teleport_duration:4\
...
execute at @n[type=minecraft:marker,tag=DoorSlotMarker3,distance=..5] run \
summon minecraft:item_display ~ ~ ~ {Rotation:[180.0f,0.0f],billboard:"fixed",interpolation_duration:3,teleport_duration:4\
...
execute at @n[type=minecraft:marker,tag=DoorSlotMarker4,distance=..5] run \
summon minecraft:item_display ~ ~ ~ {Rotation:[180.0f,0.0f],billboard:"fixed",interpolation_duration:3,teleport_duration:4\
...
execute at @n[type=minecraft:marker,tag=DoorSlotMarker5,distance=..5] run \
summon minecraft:item_display ~ ~ ~ {Rotation:[180.0f,0.0f],billboard:"fixed",interpolation_duration:3,teleport_duration:4\
...
execute at @n[type=minecraft:marker,tag=DoorSlotMarker6,distance=..5] run \
summon minecraft:item_display ~ ~ ~ {Rotation:[180.0f,0.0f],billboard:"fixed",interpolation_duration:3,teleport_duration:4\

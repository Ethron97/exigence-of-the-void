...
execute in exigence:hub positioned 0.55 209.50 110.46 run data modify entity @n[type=minecraft:item_display,tag=DoorChannelsInv,distance=..5] Glowing set value false

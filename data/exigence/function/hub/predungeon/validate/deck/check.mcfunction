...
execute as @n[distance=..16,type=item_display,tag=PredungeonAnalyzerDisplay,tag=RefreshButton] run function exigence:hub/deck_analyzer/refresh_button/calls/refresh/refresh

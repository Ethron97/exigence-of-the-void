...
# Summon item display
summon item_display ~ ~ ~ {teleport_duration:4,Rotation:[0.0f,0.0f],billboard:"fixed",Tags:["DifficultySelectorDisplay","MenuDisplay","NewItemDisplay"],item:{id:"minecraft:sunflower",count:1},\

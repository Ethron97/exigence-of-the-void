...
# Default gray
data modify entity @n[distance=..0.1,type=minecraft:text_display,tag=NewTextDisplay] text.extra[0].color set value "gray"
# If player is online, yellow
execute as @a if score @s career.player_id = #compare profile.node.player_id run data modify entity @n[distance=..0.1,type=minecraft:text_display,tag=NewTextDisplay] text.extra[0].color set value "yellow"

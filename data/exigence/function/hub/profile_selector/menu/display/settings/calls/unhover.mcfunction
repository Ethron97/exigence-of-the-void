...
#say Unhover (settings)

# Remove setting description (if exists)
#kill @n[distance=..7,type=text_display,tag=SettingDescription]
#kill @n[distance=..7,type=text_display,tag=SettingDescriptionTitle]

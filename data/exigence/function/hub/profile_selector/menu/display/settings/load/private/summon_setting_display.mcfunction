...
# Assign data
data modify entity @n[distance=..1,type=item_display,tag=NewItemDisplay] item.components."minecraft:custom_data".player_id set from storage exigence:temp player_id
data modify entity @n[distance=..1,type=item_display,tag=NewItemDisplay] item.components."minecraft:custom_data".profile_selector_id set from storage exigence:temp profile_selector_id
...
execute store result score @n[distance=..1,type=item_display,tag=NewItemDisplay] hub.entity.profile_selector_id run data get storage exigence:temp profile_selector_id

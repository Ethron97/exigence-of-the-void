...
data modify entity @s item.components."minecraft:custom_data".display set value {text:"Animate coin conversion"}
data modify entity @s item.components."minecraft:custom_data".display0 set value {text:"Animate coin conversion"}
data modify entity @s item.components."minecraft:custom_data".display1 set value {text:"Animate coin conversion"}

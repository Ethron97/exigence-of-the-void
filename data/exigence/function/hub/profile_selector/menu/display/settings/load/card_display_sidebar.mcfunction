...
run function exigence:hub/profile_selector/menu/display/settings/load/load_data/card_display_sidebar

# Summon preview
execute at @s positioned ~5.47 ~2.0 ~0.57 as @n[type=minecraft:item_display,tag=NewItemDisplay,distance=..16] run function exigence:hub/profile_selector/menu/display/settings/calls/private/create_preview with entity @s item.components."minecraft:custom_data"

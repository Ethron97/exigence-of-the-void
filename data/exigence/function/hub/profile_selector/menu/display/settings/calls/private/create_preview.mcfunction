...
$execute if score toggle.menu debug matches 1 if score debug.level debug matches 4.. run say (D4 Menu) Create preview $(preview_scale)
...
execute if score @s Random matches 0 run data modify entity @n[type=minecraft:text_display,tag=NewTextDisplay,distance=..0.1] text set from entity @s item.components."minecraft:custom_data".preview0
execute if score @s Random matches 1 run data modify entity @n[type=minecraft:text_display,tag=NewTextDisplay,distance=..0.1] text set from entity @s item.components."minecraft:custom_data".preview1
execute if score @s Random matches 2 run data modify entity @n[type=minecraft:text_display,tag=NewTextDisplay,distance=..0.1] text set from entity @s item.components."minecraft:custom_data".preview2

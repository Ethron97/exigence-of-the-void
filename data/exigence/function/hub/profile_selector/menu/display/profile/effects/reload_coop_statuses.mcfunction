...
# Called when a coop profile is loaded to slot (creation or room enter), or a coop player leaves the profile
...
execute if score toggle.menu debug matches 1 if score debug.level debug matches 3.. run say (D3) Load/Reload coop statuses

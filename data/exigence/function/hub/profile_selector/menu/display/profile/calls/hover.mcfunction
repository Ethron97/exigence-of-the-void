...
execute at @s as @n[type=minecraft:item_display,tag=SlotDisplay,tag=CreationProcess,distance=..16] run function exigence:hub/profile_selector/menu/display/profile/create_new_cancel with entity @s item.components."minecraft:custom_data"

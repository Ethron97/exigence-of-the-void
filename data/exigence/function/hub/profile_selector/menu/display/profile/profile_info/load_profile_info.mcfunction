...
execute if score #temp Temp matches 1 run data modify entity @n[type=minecraft:text_display,tag=NewDisplay,tag=Main,distance=..5] text.extra[1].text set value "\nRadiant"
execute if score #temp Temp matches 1 run data modify entity @n[type=minecraft:text_display,tag=NewDisplay,tag=Main,distance=..5] text.extra[1].color set value "yellow"

execute if score #temp Temp matches 2 run data modify entity @n[type=minecraft:text_display,tag=NewDisplay,tag=Main,distance=..5] text.extra[1].text set value "\nAncient"
execute if score #temp Temp matches 2 run data modify entity @n[type=minecraft:text_display,tag=NewDisplay,tag=Main,distance=..5] text.extra[1].color set value "gold"

execute if score #temp Temp matches 3 run data modify entity @n[type=minecraft:text_display,tag=NewDisplay,tag=Main,distance=..5] text.extra[1].text set value "\nAscendant"
execute if score #temp Temp matches 3 run data modify entity @n[type=minecraft:text_display,tag=NewDisplay,tag=Main,distance=..5] text.extra[1].color set value "red"
...
data modify entity @n[type=minecraft:text_display,tag=NewDisplay,tag=Main,distance=..5] text.extra[3] set value {score:{name:"#temp2",objective:"Temp"},color:white}
execute if score #temp Temp matches 1.. run data modify entity @n[type=minecraft:text_display,tag=NewDisplay,tag=Main,distance=..5] text.extra[4] set value {text:"/",color:"#DAD2BC"}
execute if score #temp Temp matches 1.. run data modify entity @n[type=minecraft:text_display,tag=NewDisplay,tag=Main,distance=..5] text.extra[5] set value {text:"100",color:"dark_purple"}
...
data modify entity @n[type=minecraft:text_display,tag=NewDisplay,tag=Time,distance=..5] text set value \
...
#execute store result score @e[distance=..5,type=minecraft:text_display,tag=NewDisplay] hub.entity.profile_selector_id run data get entity @s item.components."minecraft:custom_data".profile_selector_id

...
execute at @s unless entity @p[distance=..24,scores={career.exigence_level=4..}] run function exigence:hub/profile_selector/menu/display/difficulty_selector/summon_selector_4_locked with entity @s item.components."minecraft:custom_data"
execute at @s if entity @p[distance=..24,scores={career.exigence_level=4..}] run function exigence:hub/profile_selector/menu/display/difficulty_selector/summon_selector_4 with entity @s item.components."minecraft:custom_data"

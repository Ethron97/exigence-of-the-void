...
execute as @a unless score @s hub.player.profile_selector_id = #compare hub.profile_selector_id run function exigence:hub/profile_selector/menu/display/player_head/load/upsert_player

...
summon minecraft:text_display ~ ~ ~ {teleport_duration:4,billboard:"fixed",alignment:"center",Tags:["PendingTitle","NewTextDisplay"]\
,text:[{text:"Waiting for response...",color:"yellow"}]\

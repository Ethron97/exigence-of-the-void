...
tag @n[type=minecraft:item_display,tag=NewItemDisplay,distance=..1] add HidingHead
...
data modify entity @n[type=minecraft:item_display,tag=NewItemDisplay,distance=..1] item.components."minecraft:profile" set from storage exigence:temp profile

execute store result entity @n[type=minecraft:item_display,tag=NewItemDisplay,distance=..1] item.components."minecraft:custom_data".head_player_id int 1 run scoreboard players get @s career.player_id
scoreboard players operation @n[type=minecraft:item_display,tag=NewItemDisplay,distance=..1] hub.entity.player_id = @s career.player_id

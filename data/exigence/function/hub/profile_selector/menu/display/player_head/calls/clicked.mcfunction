...
execute if score #o Temp matches 0 as @p[tag=Interacting,distance=..16,predicate=!exigence:player/sneaking] run function exigence:hub/profile_selector/menu/display/coop_invitor/invite/message/pending
execute if score #o Temp matches 0 if entity @p[tag=Interacting,distance=..16,predicate=exigence:player/sneaking] \

...
execute if score toggle.menu debug matches 1 if score debug.level debug matches 3.. run say (D3) Cancel invite from decline
...
scoreboard players set #from_ Temp 1

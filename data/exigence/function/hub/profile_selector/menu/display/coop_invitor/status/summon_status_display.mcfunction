...
## INPUT
#   STR num, value between 1-3

#=============================================================================================================

# Summon text display
$summon minecraft:text_display ~ ~ ~ {billboard:"fixed",alignment:"left",Tags:["StatusDisplay","StatusDisplay$(num)","NewTextDisplay"],background:1\
,text:[{text:"P$(num): ",color:"white"},{text:"",color:"yellow"},{text:"",color:"yellow"}]\

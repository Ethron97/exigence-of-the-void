...
execute if score toggle.menu debug matches 1 if score debug.level debug matches 3.. run say (D3) Try send invite
...
#====================================================================================================
# Success:
execute at @p[tag=SendingInvite,distance=..0.01] run function exigence:hub/profile_selector/menu/display/coop_invitor/invite/send_invite

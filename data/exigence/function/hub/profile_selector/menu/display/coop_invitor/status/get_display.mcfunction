...
execute if score #temp2 Temp matches 3 in exigence:hub positioned 999 128 6.5 as @n[distance=..200,type=text_display,tag=StatusDisplay,tag=StatusDisplay3] \
...
execute if score #temp2 Temp matches 2 in exigence:hub positioned 999 128 6.5 as @n[distance=..200,type=text_display,tag=StatusDisplay,tag=StatusDisplay2] \
if score @s hub.entity.profile_selector_id = #compare hub.player.profile_selector_id run function exigence:hub/profile_selector/menu/display/coop_invitor/status/claim_display

execute if score #temp2 Temp matches 1 in exigence:hub positioned 999 128 6.5 as @n[distance=..200,type=text_display,tag=StatusDisplay,tag=StatusDisplay1] \
if score @s hub.entity.profile_selector_id = #compare hub.player.profile_selector_id run function exigence:hub/profile_selector/menu/display/coop_invitor/status/claim_display

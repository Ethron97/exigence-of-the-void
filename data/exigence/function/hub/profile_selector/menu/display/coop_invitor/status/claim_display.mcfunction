...
execute in exigence:profile_data positioned 8 0 8 as @e[type=armor_stand,tag=PlayerNode,distance=..32] if score @s profile.node.player_id = #target career.player_id \

...
execute as @e[type=minecraft:marker,scores={Rarity=1},tag=EmberShopNode,tag=!Purchaseable,tag=!Void,sort=random,limit=3] run function exigence:hub/ember_shop/make_purchasable
execute as @e[type=minecraft:marker,scores={Rarity=2},tag=EmberShopNode,tag=!Purchaseable,tag=!Void,sort=random,limit=3] run function exigence:hub/ember_shop/make_purchasable
execute as @e[type=minecraft:marker,scores={Rarity=3},tag=EmberShopNode,tag=!Purchaseable,tag=!Void,sort=random,limit=3] run function exigence:hub/ember_shop/make_purchasable
execute as @e[type=minecraft:marker,scores={Rarity=4},tag=EmberShopNode,tag=!Purchaseable,tag=!Void,sort=random,limit=3] run function exigence:hub/ember_shop/make_purchasable
...
execute as @a[scores={game.player.mod.void_crystal=1},tag=EmberShopping] run function exigence:hub/ember_shop/private/bonus_card_void

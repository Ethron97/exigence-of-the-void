...
#execute positioned ~ ~ ~-7.49 rotated 0 0 summon marker run function exigence:hub/predungeon/load/setup_deck_analyzer

#====================================================================================================

# Load predungeon menu
execute positioned ~6.49 ~ ~ run function exigence:hub/ember_shop/menu/load_menu

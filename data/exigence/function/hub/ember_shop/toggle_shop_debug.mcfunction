...
execute if data storage exigence:debug {ember_shop:1} run scoreboard players set #temp debug 0
execute if data storage exigence:debug {ember_shop:0} run scoreboard players set #temp debug 1

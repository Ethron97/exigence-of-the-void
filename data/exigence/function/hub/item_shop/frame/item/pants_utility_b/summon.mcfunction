...
data modify entity @s Item.components."minecraft:custom_data".item_name set value 'pants_utility_b'
...
data modify entity @s Item.components."minecraft:lore" append value [{text:"limit increased by 2",italic:false,color:"gray"}]

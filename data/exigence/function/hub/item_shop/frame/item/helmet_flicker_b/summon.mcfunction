...
{text:"Spark II",italic:false,bold:true,color:"$(rare)"},{text:" ⛑",italic:false,bold:true,color:"white"}]}}}

data modify entity @s Item.components."minecraft:custom_data".item_name set value 'helmet_flicker_b'
...
$data modify entity @s Item.components."minecraft:lore" append value [{text:"+24 ",italic:false,color:"gray"}\
,{text:"Flicker ",italic:false,color:"$(effect)"},{text:"range",italic:false,color:"gray"}]
$data modify entity @s Item.components."minecraft:lore" append value [{text:"+15s to ",italic:false,color:"gray"},{text:"Flicker ",italic:false,color:"$(effect)"},{text:"from cards",italic:false,color:"gray"}]

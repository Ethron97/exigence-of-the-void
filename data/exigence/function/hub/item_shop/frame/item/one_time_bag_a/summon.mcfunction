...
data modify entity @s Item.components."minecraft:custom_data".item_name set value 'one_time_bag_a'
...
#data modify entity @s Item.components."minecraft:lore" append value [{text:"Increase Bag ",italic:false,color:"gray"},{text:"💼 ",italic:false,color:"yellow"},{text:"item limit by 1 ",italic:false,color:"gray"}]

...
data modify entity @s Item.components."minecraft:custom_data".item_name set value 'chestplate_regen_b'
...
#data modify entity @s Item.components."minecraft:trim" set value {pattern:'minecraft:snout',material:"quartz"}
...
data modify entity @s Item.components."minecraft:lore" append value [{text:"from cards by +10 seconds",italic:false,color:"gray"}]

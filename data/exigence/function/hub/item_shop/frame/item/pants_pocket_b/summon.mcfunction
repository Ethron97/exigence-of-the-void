...
data modify entity @s Item.components."minecraft:custom_data".item_name set value 'pants_pocket_b'
...
data modify entity @s Item.components."minecraft:lore" append value [{text:"Bag ",italic:false,color:"gray"},{text:"💼 ",italic:false,color:"yellow"},{text:"item limit increased by 1",italic:false,color:"gray"}]

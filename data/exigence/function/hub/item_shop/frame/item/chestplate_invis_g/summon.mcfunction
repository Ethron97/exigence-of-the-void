...
data modify entity @s Item.components."minecraft:custom_data".item_name set value 'chestplate_invis_g'
...
data modify entity @s Item.components."minecraft:trim" set value {pattern:'minecraft:raiser',material:"diamond"}
...
$data modify entity @s Item.components."minecraft:lore" append value [{text:"While you are ",italic:false,color:"gray"}\
,{text:"Invisible",italic:false,color:"$(effect)"},{text:", gain ",italic:false,color:"gray"},{text:"Speed II",italic:false,color:"$(effect)"},{text:"",italic:false,color:"gray"}]
#$data modify entity @s Item.components."minecraft:lore" append value [{text:"gain an equal duration of ",italic:false,color:"gray"},{text:"Speed II",italic:false,color:"$(effect)"},{text:".",italic:false,color:"gray"}]
data modify entity @s Item.components."minecraft:lore" append value {text:""}

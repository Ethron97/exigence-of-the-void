...
{text:"Feather Boots IV",italic:false,bold:true,color:"$(rare)"},{text:" 🥾",italic:false,bold:true,color:"white"}]}}}

data modify entity @s Item.components."minecraft:custom_data".item_name set value 'boots_feather_d'
...
data modify entity @s Item.components."minecraft:lore" append value [{text:"Reduce fall damage by 48%",italic:false,color:"gray"}]

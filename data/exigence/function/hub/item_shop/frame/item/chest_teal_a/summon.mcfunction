...
data modify entity @s Item.components."minecraft:custom_data".item_name set value 'chest_teal_a'
...
data modify entity @s Item.components."minecraft:lore" append value [{text:"Increase max ",italic:false,color:"gray"},{text:"❂",italic:false,color:"dark_green"},{text:"❂ ",italic:false,color:"aqua"},{text:"by 2",italic:false,color:"gray"}]

...
data modify entity @s Item.components."minecraft:custom_data".item_name set value 'boots_panic_f'
...
$data modify entity @s Item.components."minecraft:lore" append value [{text:"Gain +10s ",italic:false,color:"gray"}\
,{text:"Speed II",italic:false,color:"$(effect)"},{text:", +10s ",italic:false,color:"gray"},{text:"Jump II",italic:false,color:"$(effect)"}]

...
data modify entity @s Item.components."minecraft:custom_data".item_name set value 'chestplate_regen_g'
...
data modify entity @s Item.components."minecraft:trim" set value {pattern:'minecraft:snout',material:"amethyst"}
...
$data modify entity @s Item.components."minecraft:lore" append value [{text:"gain ",italic:false,color:"gray"},{text:"Regeneration II ",italic:false,color:"$(effect)"},{text:"instead",italic:false,color:"gray"}]
data modify entity @s Item.components."minecraft:lore" append value {text:""}

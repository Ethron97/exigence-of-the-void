...
data modify entity @s Item.components."minecraft:custom_data".item_name set value 'chestplate_shield_e'
...
data modify entity @s Item.components."minecraft:trim" set value {pattern:'minecraft:flow',material:"copper"}
...
$data modify entity @s Item.components."minecraft:lore" append value [{text:"While you have any ",italic:false,color:"gray"}\
,{text:"❤",italic:false,color:"gold"},{text:", gain ",italic:false,color:"gray"},{text:"Speed",italic:false,color:"$(effect)"},{text:"",italic:false,color:"gray"}]
data modify entity @s Item.components."minecraft:lore" append value {text:""}

...
data modify entity @s Item.components."minecraft:custom_data".item_name set value 'boots_panic_e'
...
,{text:"Speed II",italic:false,color:"$(effect)"},{text:", +4s ",italic:false,color:"gray"},{text:"Jump II",italic:false,color:"$(effect)"}]

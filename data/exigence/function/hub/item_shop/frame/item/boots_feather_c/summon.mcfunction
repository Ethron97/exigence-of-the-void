...
{text:"Feather Boots III",italic:false,bold:true,color:"$(rare)"},{text:" 🥾",italic:false,bold:true,color:"white"}]}}}

data modify entity @s Item.components."minecraft:custom_data".item_name set value 'boots_feather_c'
data modify entity @s Item.components."minecraft:custom_data".is_soulbound set value 1b
data modify entity @s Item.components."minecraft:unbreakable" set value {}
data modify entity @s Item.components."minecraft:enchantments" set value {feather_falling:3}
...
data modify entity @s Item.components."minecraft:lore" append value [{text:"Reduce fall damage by 36%",italic:false,color:"gray"}]

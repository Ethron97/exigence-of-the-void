...
{text:"Safe Pockets I",italic:false,color:"$(uncommon)",bold:true},{text:" 👖",italic:false,color:"white"}]}}}

data modify entity @s Item.components."minecraft:custom_data".item_name set value 'pants_glint_a'
...
data modify entity @s Item.components."minecraft:lore" append value [{text:"Up to 3 Glint ",italic:false,color:"gray"},{text:"💎 ",italic:false,color:"gold"},{text:"are",italic:false,color:"gray"}]

...
{text:"Sculk Boots III",italic:false,bold:true,color:"$(legendary)"},{text:" 🥾",italic:false,bold:true,color:"white"}]}}}

data modify entity @s Item.components."minecraft:custom_data".item_name set value 'boots_sculk_c'
...
data modify entity @s Item.components."minecraft:lore" append value [{text:"Stepping on sculk generates 83%",italic:false,color:"gray"}]

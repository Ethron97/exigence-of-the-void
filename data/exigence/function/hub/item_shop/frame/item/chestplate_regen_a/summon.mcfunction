...
data modify entity @s Item.components."minecraft:custom_data".item_name set value 'chestplate_regen_a'
...
data modify entity @s Item.components."minecraft:lore" append value [{text:"from cards by +5 seconds",italic:false,color:"gray"}]

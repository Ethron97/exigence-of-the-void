...
{text:"Deep Pockets II",italic:false,color:"$(common)",bold:true},{text:" 👖",italic:false,color:"white"}]}}}

data modify entity @s Item.components."minecraft:custom_data".item_name set value 'pants_coin_b'
...
data modify entity @s Item.components."minecraft:lore" append value [{text:"Up to 8 coins ",italic:false,color:"gray"},{text:"🔘 ",italic:false,color:"gold"},{text:"are",italic:false,color:"gray"}]

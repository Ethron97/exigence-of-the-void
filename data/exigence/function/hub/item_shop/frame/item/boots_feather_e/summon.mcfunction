...
{text:"Feather Boots V",italic:false,bold:true,color:"$(legendary)"},{text:" 🥾",italic:false,bold:true,color:"white"}]}}}

data modify entity @s Item.components."minecraft:custom_data".item_name set value 'boots_feather_e'
...
,{type:'minecraft:safe_fall_distance',id:'exigence:safe_fall_boots',amount:10.0,operation:'add_value',slot:'feet'}]
...
data modify entity @s Item.components."minecraft:lore" append value [{text:"by 10 blocks",italic:false,color:"gray"}]

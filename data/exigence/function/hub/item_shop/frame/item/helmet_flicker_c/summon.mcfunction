...
data modify entity @s Item.components."minecraft:custom_data".item_name set value 'helmet_flicker_c'
...
$data modify entity @s Item.components."minecraft:lore" append value [{text:"+30s to ",italic:false,color:"gray"},{text:"Flicker ",italic:false,color:"$(effect)"},{text:"from cards",italic:false,color:"gray"}]

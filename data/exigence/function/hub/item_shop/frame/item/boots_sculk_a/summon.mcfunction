...
{text:"Sculk Boots I",italic:false,bold:true,color:"$(rare)"},{text:" 🥾",italic:false,bold:true,color:"white"}]}}}

data modify entity @s Item.components."minecraft:custom_data".item_name set value 'boots_sculk_a'
...
data modify entity @s Item.components."minecraft:lore" append value [{text:"Stepping on sculk generates 25%",italic:false,color:"gray"}]

...
execute as @s[tag=!Hover,tag=DisplayingCost] unless entity @a[distance=..8,tag=ItemShop,scores={shop.player.holding_currency=1}] run function exigence:menu/item_display/item_shop_display/cost_display/delete with entity @s item.components."minecraft:custom_data"

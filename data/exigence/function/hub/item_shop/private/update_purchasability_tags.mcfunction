...
# Update is parent researched (if applicable)
execute as @s[tag=HasParents,scores={shop.frame.parents=1..}] run function exigence:menu/item_display/item_shop_display/parent/is_parents_researched

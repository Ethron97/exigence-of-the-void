...
data modify entity @s Item.components."minecraft:custom_data".item_name set value 'helmet_glimmer_f'
...
$data modify entity @s Item.components."minecraft:lore" append value [{text:"+48 ",italic:false,color:"gray"}\
,{text:"Glimmer ",italic:false,color:"$(effect)"},{text:"range",italic:false,color:"gray"}]
$data modify entity @s Item.components."minecraft:lore" append value [{text:"+15s to ",italic:false,color:"gray"},{text:"Glimmer ",italic:false,color:"$(effect)"},{text:"from cards",italic:false,color:"gray"}]

...
execute if score game.is_active game.state matches 1 if entity @e[type=minecraft:marker,tag=Appeared] run schedule function exigence:vault/artifact/artifacts/dust_of_appearance/private/untrigger_loop 20t append

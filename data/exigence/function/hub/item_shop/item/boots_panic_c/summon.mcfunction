...
{text:"Panic Boots III",italic:false,bold:true,color:"$(rare)"},{text:" 🥾",italic:false,bold:true,color:"white"}]\
...
,{text:""}\
,[{text:"Gain +8s ",italic:false,color:"gray"},{text:"Speed II ",italic:false,color:"$(effect)"},{text:"whenever",italic:false,color:"gray"}]\
,[{text:"you lose any ",italic:false,color:"gray"},{text:"❤",italic:false,color:"red"}]\
],"minecraft:custom_data":{item_name:"boots_panic_c",is_soulbound:true}}}}

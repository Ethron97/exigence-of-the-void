...
{text:"Food Pocket",italic:false,color:"$(uncommon)",bold:true},{text:" 👖",italic:false,color:"white"}]\
...
,{text:""}\
,[{text:"Food ",italic:false,color:"gray"},{text:"🥣 ",italic:false,color:"yellow"},{text:"item limit increased by 1",italic:false,color:"gray"}]\
],"minecraft:custom_data":{item_name:"pants_pocket_a",is_soulbound:true}}}}

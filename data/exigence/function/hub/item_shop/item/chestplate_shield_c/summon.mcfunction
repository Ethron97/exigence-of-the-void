...
data modify entity @s Item.components."minecraft:custom_data".item_name set value 'chestplate_shield_c'
...
data modify entity @s Item.components."minecraft:lore" append value [{text:"    +6 ",italic:false,color:"gray"},{text:"❤ ",italic:false,color:"gold"},{text:"(10:00)",italic:false,color:"gray"}]

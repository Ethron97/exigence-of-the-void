...
{text:" Faerie Fire ",italic:false,bold:true,color:"$(common)"},{text:"⚗",italic:false,bold:true,color:"white"}]}}}

data modify entity @s Item.components."minecraft:custom_data".item_name set value 'potion_glow_a'
...
$data modify entity @s Item.components."minecraft:lore" append value [$(common_stars),{text:"Utility Potion",italic:false,color:"white"}]

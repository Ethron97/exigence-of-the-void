...
data modify entity @s Item.components."minecraft:custom_data".item_name set value 'chestplate_get_aqua'
data modify entity @s Item.components."minecraft:custom_data".is_soulbound set value 1b
data modify entity @s Item.components."minecraft:unbreakable" set value {}
data modify entity @s Item.components."minecraft:dyed_color" set value 3331027
...
data modify entity @s Item.components."minecraft:lore" append value [{text:"Start with +3 ",italic:false,color:"gray"},{text:"❂",italic:false,color:"aqua"}]

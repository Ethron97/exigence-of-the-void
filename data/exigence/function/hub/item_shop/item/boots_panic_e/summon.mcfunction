...
{text:"Panic Boots V",italic:false,bold:true,color:"$(legendary)"},{text:" 🥾",italic:false,bold:true,color:"white"}]\
...
,{text:""}\
,[{text:"Gain +8s ",italic:false,color:"gray"},{text:"Speed II",italic:false,color:"$(effect)"},{text:", +4s ",italic:false,color:"gray"},{text:"Jump II",italic:false,color:"$(effect)"}]\
,[{text:"whenever you lose any ",italic:false,color:"gray"},{text:"❤",italic:false,color:"red"}]\
],"minecraft:custom_data":{item_name:"boots_panic_e",is_soulbound:true}}}}

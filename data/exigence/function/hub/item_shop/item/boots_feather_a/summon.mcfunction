...
,{text:""}\
,[{text:"-12% ",italic:false,color:"$(effect)"},{text:"fall damage",italic:false,color:"gray"}]\
],"minecraft:custom_data":{item_name:"boots_feather_a",is_soulbound:true,enchanted:true}}}}

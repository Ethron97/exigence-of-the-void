...
data modify entity @s Item.components."minecraft:custom_data".item_name set value 'helmet_flicker_d'
...
$data modify entity @s Item.components."minecraft:lore" append value [{text:"+40 ",italic:false,color:"gray"}\
,{text:"Flicker ",italic:false,color:"$(effect)"},{text:"range",italic:false,color:"gray"}]
$data modify entity @s Item.components."minecraft:lore" append value [{text:"+1m to ",italic:false,color:"gray"},{text:"Flicker ",italic:false,color:"$(effect)"},{text:"from cards",italic:false,color:"gray"}]

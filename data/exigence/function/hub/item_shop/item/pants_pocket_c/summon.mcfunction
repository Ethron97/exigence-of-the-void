...
,{text:""}\
,[{text:"Potion ",italic:false,color:"gray"},{text:"🧪 ",italic:false,color:"yellow"},{text:"item limit increased by 1",italic:false,color:"gray"}]\
],"minecraft:custom_data":{item_name:"pants_pocket_c",is_soulbound:true}}}}

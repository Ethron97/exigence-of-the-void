...
data modify entity @s Item.components."minecraft:custom_data".item_name set value 'pants_coin_e'
...
data modify entity @s Item.components."minecraft:lore" append value [{text:"Up to 29 coins ",italic:false,color:"gray"},{text:"🔘 ",italic:false,color:"gold"},{text:"are",italic:false,color:"gray"}]

...
data modify entity @s Item.components."minecraft:custom_data".item_name set value 'pants_utility_c'
...
data modify entity @s Item.components."minecraft:lore" append value [{text:"limit increased by 4",italic:false,color:"gray"}]

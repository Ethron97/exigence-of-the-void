...
data modify entity @s Item.components."minecraft:custom_data".item_name set value 'pants_coin_f'
...
data modify entity @s Item.components."minecraft:lore" append value [{text:"Up to 38 coins ",italic:false,color:"gray"},{text:"🔘 ",italic:false,color:"gold"},{text:"are",italic:false,color:"gray"}]

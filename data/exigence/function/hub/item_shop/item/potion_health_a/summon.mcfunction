...
,"minecraft:lore":[[$(common_stars),{text:"Health Potion",italic:false,color:"white"}],{text:""}\
,[{text:"+2 ❤ ",italic:false,color:"gold"},{text:"Hearts (01:00)",italic:false,color:"gray"}]\
],"minecraft:custom_data":{item_name:"potion_health_a",check_holding:true}}}}

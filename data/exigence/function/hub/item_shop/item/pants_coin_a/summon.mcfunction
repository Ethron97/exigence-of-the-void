...
,{text:""}\
,[{text:"Up to 5 coins ",italic:false,color:"gray"},{text:"🔘 ",italic:false,color:"gold"},{text:"are",italic:false,color:"gray"}]\
,[{text:"Soulbound ",italic:false,color:"dark_gray"},{text:"on death",italic:false,color:"gray"}]\
],"minecraft:custom_data":{item_name:"pants_coin_a",is_soulbound:true}}}}

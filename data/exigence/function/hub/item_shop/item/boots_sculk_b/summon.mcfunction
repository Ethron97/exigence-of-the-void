...
,{text:""}\
,[{text:"Stepping on sculk generates ",italic:false,color:"gray"},{text:"50%",italic:false,color:"aqua"}]\
...
],"minecraft:custom_data":{item_name:"boots_sculk_b",is_soulbound:true}}}}

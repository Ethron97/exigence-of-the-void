...
data modify entity @s Item.components."minecraft:custom_data".item_name set value 'helmet_detection_e'
...
$data modify entity @s Item.components."minecraft:lore" append value [{text:"+64 ",italic:false,color:"gray"}\
,{text:"Clairvoyance ",italic:false,color:"$(effect)"},{text:"range",italic:false,color:"gray"}]
$data modify entity @s Item.components."minecraft:lore" append value [{text:"+30s to ",italic:false,color:"gray"},{text:"Clairvoyance ",italic:false,color:"$(effect)"},{text:"from cards",italic:false,color:"gray"}]

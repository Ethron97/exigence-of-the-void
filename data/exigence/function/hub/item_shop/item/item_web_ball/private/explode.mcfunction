...
execute if score toggle.player debug matches 1 if score debug.level debug matches 3.. run say (D3 Player) Exploding web ball
...
function exigence:hub/item_shop/item/item_web_ball/private/web_ray/new
function exigence:hub/item_shop/item/item_web_ball/private/web_ray/new
function exigence:hub/item_shop/item/item_web_ball/private/web_ray/new
function exigence:hub/item_shop/item/item_web_ball/private/web_ray/new
function exigence:hub/item_shop/item/item_web_ball/private/web_ray/new

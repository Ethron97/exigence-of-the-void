...
execute as @e[type=minecraft:snowball,distance=..1000] if score @s game.entity.snowball.id = #compare game.entity.snowball.id run scoreboard players set #explode game.entity.snowball.id 0

...
data modify entity @s Item.components."minecraft:custom_data".item_name set value 'chest_green_e'
...
data modify entity @s Item.components."minecraft:lore" append value [{text:"Increase max ",italic:false,color:"gray"},{text:"❂ ",italic:false,color:"dark_green"},{text:"by 5",italic:false,color:"gray"}]

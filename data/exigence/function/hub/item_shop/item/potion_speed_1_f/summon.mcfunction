...
,"minecraft:lore":[[$(legendary_stars),{text:"Speed Potion",italic:false,color:"white"}],{text:""}\
,[{text:"Speed I ",italic:false,color:"$(effect)"},{text:"(06:00)",italic:false,color:"gray"}]\
],"minecraft:custom_data":{item_name:"potion_speed_1_f",check_holding:true}}}}

...
,"minecraft:lore":[[$(uncommon_stars),{text:"Health Potion",italic:false,color:"white"}],{text:""}\
,[{text:"+6 ❤ ",italic:false,color:"gold"},{text:"Hearts (01:00)",italic:false,color:"gray"}]\
],"minecraft:custom_data":{item_name:"potion_health_c",check_holding:true}}}}

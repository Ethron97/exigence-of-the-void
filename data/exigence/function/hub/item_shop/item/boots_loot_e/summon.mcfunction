...
{text:"Loot Boots V",italic:false,bold:true,color:"$(legendary)"},{text:" 🥾",italic:false,bold:true,color:"white"}]\
...
,{text:""}\
,[{text:"Gain +9s ",italic:false,color:"gray"},{text:"Speed II ",italic:false,color:"$(effect)"},{text:"whenever",italic:false,color:"gray"}]\
,[{text:"you pick up a coin ",italic:false,color:"gray"},{text:"🔘",color:"gold"}]\
],"minecraft:custom_data":{item_name:"boots_loot_e",is_soulbound:true}}}}

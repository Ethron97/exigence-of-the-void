...
{text:"Panic Boots VI",italic:false,bold:true,color:"$(legendary)"},{text:" 🥾",italic:false,bold:true,color:"white"}]\
...
,{text:""}\
,[{text:"Gain +10s ",italic:false,color:"gray"},{text:"Speed II",italic:false,color:"$(effect)"},{text:", +10s ",italic:false,color:"gray"},{text:"Jump II",italic:false,color:"$(effect)"}]\
,[{text:"whenever you lose any ",italic:false,color:"gray"},{text:"❤",italic:false,color:"red"}]\
],"minecraft:custom_data":{item_name:"boots_panic_f",is_soulbound:true}}}}

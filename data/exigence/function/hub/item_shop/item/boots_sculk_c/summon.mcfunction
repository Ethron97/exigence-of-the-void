...
,"minecraft:trim":{pattern:'minecraft:silence',material:"amethyst"}\
...
,{text:""}\
,[{text:"Stepping on sculk generates ",italic:false,color:"gray"},{text:"83%",italic:false,color:"aqua"}]\
...
],"minecraft:custom_data":{item_name:"boots_sculk_c",is_soulbound:true}}}}

...
execute if entity @s[advancements={exigence:unlockables/shop_unlock_item_dust_heighten=true}] run data modify storage exigence:shop shop_unlocked append value dust_heighten
execute if entity @s[advancements={exigence:unlockables/shop_unlock_item_chorus_fruit=true}] run data modify storage exigence:shop shop_unlocked append value chorus_fruit
...
execute if entity @s[advancements={exigence:unlockables/shop_unlock_item_resonance_crystal=true}] run data modify storage exigence:shop shop_unlocked append value resonance_crystal
execute if entity @s[advancements={exigence:unlockables/shop_unlock_item_glow_ink_sac=true}] run data modify storage exigence:shop shop_unlocked append value glow_ink_sac

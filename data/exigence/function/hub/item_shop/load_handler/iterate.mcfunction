...
execute as @e[predicate=exigence:region/item_shop,type=minecraft:item_display,tag=ItemShopDisplay,tag=!Loaded] if score @s shop.frame.tier = #i Temp run tag @s add IterateCandidate

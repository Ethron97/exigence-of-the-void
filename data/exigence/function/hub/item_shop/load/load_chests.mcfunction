...
execute if score toggle.hub debug matches 1 if score debug.level debug matches 2.. run say (D2) Load chests (item shop)
...
data modify block ~-1 ~ ~3 Items set from storage exigence:profile chests.green_left
data modify block ~-2 ~ ~3 Items set from storage exigence:profile chests.green_right
data modify block ~-1 ~ ~3 CustomName set from storage exigence:profile chests.green_name
...
data modify block ~-2 ~ ~-3 Items set from storage exigence:profile chests.orange_left
data modify block ~-1 ~ ~-3 Items set from storage exigence:profile chests.orange_right
data modify block ~-2 ~ ~-3 CustomName set from storage exigence:profile chests.orange_name

...
execute if score toggle.hub debug matches 1 if score debug.level debug matches 2.. run say (D2 Hub) Save chests [item shop]
...
function exigence:hub/item_shop/load/remove_chests
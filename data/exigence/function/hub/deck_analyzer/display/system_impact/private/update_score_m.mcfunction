...
$execute if score #temp2 Temp matches 200000.. at @s at @n[tag=BarChart,tag=$(class),distance=..3] positioned ^-0.12 ^ ^ run tp @s ^$(length) ^0.01 ^0.01
$execute if score #temp2 Temp matches ..199999 at @s at @n[tag=BarChart,tag=$(class),distance=..3] positioned ^0.08 ^ ^ run tp @s ^$(length) ^0.01 ^0.01

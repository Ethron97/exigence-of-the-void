...
# ^> INPUT:
execute as @n[type=minecraft:text_display,tag=NewTextDisplay,distance=..0.1] run function exigence:hub/deck_analyzer/refresh_button/calls/private/show_hover_name_data

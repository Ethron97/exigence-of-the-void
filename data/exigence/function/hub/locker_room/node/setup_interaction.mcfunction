...
scoreboard players operation @n[type=interaction,tag=NewLockerRoomInteraction,distance=..0.1] hub.entity.locker_room_id = @n[type=minecraft:marker,tag=LockerRoomNode,distance=..0.1] hub.locker_room_id

...
execute in exigence:hub positioned 0 200 0 as @e[x=-29,y=197,z=6,dx=24,dy=8,dz=24,type=minecraft:marker,tag=LockerRoomNode] \
...
execute in exigence:hub positioned 0 200 0 at @n[x=-29,y=197,z=6,dx=24,dy=8,dz=24,type=minecraft:marker,tag=LockerRoomNode,tag=TeleportToThisOne] run function exigence:hub/locker_room/access/enter_coop

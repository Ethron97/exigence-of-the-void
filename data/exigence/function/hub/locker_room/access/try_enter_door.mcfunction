...
execute if score toggle.hub debug matches 1 if score debug.level debug matches 3.. run say (D3 Hub) Try enter locker room
...
# Node is in use
execute if score @n[type=minecraft:marker,tag=LockerRoomNode,distance=..0.1] hub.locker_room_id matches 1.. run return run function exigence:hub/locker_room/access/fail/in_use
#----------------------------------------------------------------------------------------------------

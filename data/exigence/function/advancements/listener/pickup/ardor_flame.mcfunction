...
execute if data storage exigence:dungeon {is_active:1} at @s run execute as @e[type=minecraft:item,tag=ArdorFlame,distance=..1000] if score @s ObjectLevel = #compare ObjectLevel run kill @s

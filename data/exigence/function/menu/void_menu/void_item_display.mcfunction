...
# Call data function
$execute as @n[distance=..0.1,type=minecraft:item,tag=NVS] run function exigence:menu/void_menu/private/void_item_display_data {item_name:'$(item_name)',money_cost:$(money_cost),Rotation:'$(Rotation)'}

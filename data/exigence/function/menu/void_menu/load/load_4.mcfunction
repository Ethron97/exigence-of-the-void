...
execute at @s positioned ^ ^1 ^1 run function exigence:menu/void_menu/load/load_macro with storage exigence:void_shop
...
execute at @s positioned ^ ^1.7 ^1 run function exigence:menu/void_menu/load/load_macro with storage exigence:void_shop

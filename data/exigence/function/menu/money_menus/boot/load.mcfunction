...
# FEATHER BOOTS
$execute positioned ^0.5 ^2 ^ run function exigence:menu/money_menus/money_item_display {menu_tag:'MenuBoots',item_name:'boots_feather_a',rarity:2,tier:3,money_cost:5,research_cost:5,parents:['boots_snow'],Rotation:'$(Rotation)'}
$execute positioned ^0.5 ^2.75 ^ run function exigence:menu/money_menus/money_item_display {menu_tag:'MenuBoots',item_name:'boots_feather_b',rarity:2,tier:4,money_cost:7,research_cost:10,parents:['boots_feather_a'],Rotation:'$(Rotation)'}
$execute positioned ^0.5 ^3.5 ^ run function exigence:menu/money_menus/money_item_display {menu_tag:'MenuBoots',item_name:'boots_feather_c',rarity:3,tier:5,money_cost:9,research_cost:16,parents:['boots_feather_b'],Rotation:'$(Rotation)'}
$execute positioned ^0.5 ^4.25 ^ run function exigence:menu/money_menus/money_item_display {menu_tag:'MenuBoots',item_name:'boots_feather_d',rarity:3,tier:6,money_cost:11,research_cost:24,parents:['boots_feather_c'],Rotation:'$(Rotation)'}
$execute positioned ^0.5 ^5 ^ run function exigence:menu/money_menus/money_item_display {menu_tag:'MenuBoots',item_name:'boots_feather_e',rarity:4,tier:7,money_cost:14,research_cost:40,parents:['boots_feather_d'],Rotation:'$(Rotation)'}
$execute positioned ^0.5 ^5.75 ^ run function exigence:menu/money_menus/money_item_display {menu_tag:'MenuBoots',item_name:'boots_feather_f',rarity:4,tier:8,money_cost:20,research_cost:64,parents:['boots_feather_e'],Rotation:'$(Rotation)'}

...
$execute unless entity @e[type=item,tag=NSS] run function exigence:hub/item_shop/frame/item/summon_item {item_name:'$(item_name)'}
...
$scoreboard players set #compare Rarity $(rarity)
# Tier (sub-rarity)
$scoreboard players set #compare ItemShopTier $(tier)

...
$execute unless entity @n[type=minecraft:item,tag=NSS,distance=..0.01] run function exigence:hub/item_shop/item/summon_item_for_display {item_name:'$(item_name)'}

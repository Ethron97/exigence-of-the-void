...
scoreboard players set @a[tag=ItemShopping] LookingAtIDID 0
...
execute as @a[tag=ItemShopping,scores={LookingAtIDID=0}] run function exigence:player/utility/interaction/tp_home

...
execute as @a[scores={dead=0,game.player.vault_code=0},tag=ActivePlayer] at @s run function exigence:menu/item_display/void_shop_display/items/clock/new_marker

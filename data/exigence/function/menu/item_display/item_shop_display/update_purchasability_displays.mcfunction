...
team join Spectator @s[tag=!CanBuy]
...
## COST DISPLAY COLORS
data modify entity @s[tag=!CanBuy] item.components."minecraft:custom_data".money_color set value gray
data modify entity @s[tag=!CanBuy] item.components."minecraft:custom_data".research_color set value gray

# Same logic as GLOW COLOR but for chat color (can't detect teams on non-living entities)
execute if entity @s[tag=CanBuy] run data modify entity @s item.components."minecraft:custom_data".money_color set value aqua
execute if entity @s[tag=CanResearch] run data modify entity @s item.components."minecraft:custom_data".research_color set value light_purple

execute if entity @s[tag=!CanBuy,tag=IsResearched] run data modify entity @s item.components."minecraft:custom_data".money_color set value red
execute if entity @s[tag=!CanResearch,tag=!IsResearched] run data modify entity @s item.components."minecraft:custom_data".research_color set value red

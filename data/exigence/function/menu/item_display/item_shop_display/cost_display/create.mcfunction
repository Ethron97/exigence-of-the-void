...
$execute at @s positioned ^ ^-0.6 ^0.1 run summon minecraft:text_display ~ ~ ~ {Rotation:$(Rotation),Tags:["CostDisplay","NewCostDisplay"],text:{text:""},billboard:"fixed",alignment:"center",background:1,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0.0f,0.0f,0.0f],scale:[1.0f,1.0f,1.0f]}}

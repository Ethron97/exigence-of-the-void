...
execute as @n[tag=DrawLineTo,distance=..5] run function exigence:menu/item_display/item_shop_display/parent_line/private/save_coords
...
# Remove tag
tag @n[tag=DrawLineTo,distance=..5] remove DrawLineTo

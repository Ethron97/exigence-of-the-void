...
# Handle data
execute as @n[type=minecraft:block_display,tag=NewMenuLine,distance=..1] run function exigence:menu/item_display/item_shop_display/parent_line/private/menu_line_data with storage exigence:menu

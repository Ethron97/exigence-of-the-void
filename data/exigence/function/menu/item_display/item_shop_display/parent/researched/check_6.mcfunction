...
# Recursively check down (if needed)
execute if entity @s[tag=!IsParentResearched] run function exigence:menu/item_display/item_shop_display/parent/researched/check_5
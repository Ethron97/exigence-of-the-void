...
execute unless data entity @s item.components."minecraft:custom_data".parents[2] run say I don't have a parent? (2)
...
function exigence:menu/item_display/item_shop_display/parent/connect/connect_2
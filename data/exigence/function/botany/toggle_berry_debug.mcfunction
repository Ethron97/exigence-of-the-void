...
$execute if data storage exigence:debug {berry:1} as @e[type=minecraft:armor_stand,scores={ObjectLevel=$(levels)},tag=BerryNode] run data merge entity @s {Glowing:1b,CustomNameVisible:1b,Invisible:0b,Marker:0b}

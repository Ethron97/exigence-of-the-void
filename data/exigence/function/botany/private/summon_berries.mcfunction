...
$execute if score mod.ambrosia game.modifiers matches 0 run summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:melon_slice",\
...
# If ambrosia:
$execute if score mod.ambrosia game.modifiers matches 1.. run summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:melon_slice",\

...
execute if score @s game.node.node_state matches 0 if score #blaze_powder Temp matches 0 if score #spark Temp matches 0 run function exigence:altar/node/private/light_standard

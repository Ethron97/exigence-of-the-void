...
execute at @s as @e[type=minecraft:armor_stand,tag=ChosenEchoNode,sort=nearest,limit=1] store result storage exigence:compass echo_id int 1 run scoreboard players get @s game.node.echo.id

...
execute if score EchosRequired DungeonRun matches 2.. if score @s EchoFragments matches 1.. if data storage exigence:dungeon {all_echos_found:0} run title @s actionbar {text:"You must collect all the Echo Fragments to escape!",color:"red"}
...
execute if score @s EchoFragments matches 1.. if data storage exigence:dungeon {all_echos_found:1} run function exigence:player/game/escape

...
execute if data storage exigence:debug {todo:1} run scoreboard players set #temp debug 0
execute if data storage exigence:debug {todo:0} run scoreboard players set #temp debug 1

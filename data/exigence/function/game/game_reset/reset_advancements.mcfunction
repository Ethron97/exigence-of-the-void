# Reset game-event advancements, just in case they broked.
...
advancement revoke @s[advancements={exigence:listener/consume/eat_honey_bottle=true}] only exigence:listener/consume/eat_honey_bottle
advancement revoke @s[advancements={exigence:listener/consume/eat_melon_slice=true}] only exigence:listener/consume/eat_melon_slice
advancement revoke @s[advancements={exigence:listener/consume/eat_suspicious_stew=true}] only exigence:listener/consume/eat_suspicious_stew
...
advancement revoke @s[advancements={exigence:listener/pickup/coin=true}] only exigence:listener/pickup/coin
advancement revoke @s[advancements={exigence:listener/pickup/echo=true}] only exigence:listener/pickup/echo
advancement revoke @s[advancements={exigence:listener/pickup/ember_echo_big=true}] only exigence:listener/pickup/ember_echo_big
advancement revoke @s[advancements={exigence:listener/pickup/ember_echo=true}] only exigence:listener/pickup/ember_echo
advancement revoke @s[advancements={exigence:listener/pickup/ember=true}] only exigence:listener/pickup/ember
advancement revoke @s[advancements={exigence:listener/pickup/level_1_key=true}] only exigence:listener/pickup/level_1_key
advancement revoke @s[advancements={exigence:listener/pickup/level_2_key=true}] only exigence:listener/pickup/level_2_key
...
advancement revoke @s[advancements={exigence:listener/use_wooden_pick=true}] only exigence:listener/use_wooden_pick

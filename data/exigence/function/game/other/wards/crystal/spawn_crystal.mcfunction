...
tag @e[type=minecraft:marker,scores={node.property.object_level=4},tag=EchoNode,tag=!ChosenEchoNode,tag=!ChosenCrystal] add CrystalCandidate
tag @e[type=minecraft:marker,scores={node.property.object_level=4},tag=MenaceNode,tag=!Ravagered,tag=!ChosenCrystal] add CrystalCandidate
...
tag @e[type=minecraft:marker,tag=CrystalCandidate,sort=random,limit=1] add NewChosenCrystal
tag @e[type=minecraft:marker,tag=NewChosenCrystal] add ChosenCrystal
...
# Summon interaction
$execute at @e[type=minecraft:armor_stand,tag=NewChosenCrystal] run summon minecraft:interaction ~ ~1 ~ {Tags:[NewCrystal,Crystal,$(color)],response:1b}

# Give data etc
scoreboard players set @e[type=minecraft:interaction,tag=NewCrystal] game.entity.object_level 4

# Copy node id
scoreboard players operation @e[type=minecraft:interaction,tag=NewCrystal] game.story.ward_crystal.node_id = @e[type=minecraft:armor_stand,tag=NewChosenCrystal] node.id
...
# Remove local tags
tag @e[type=minecraft:armor_stand,tag=CrystalCandidate] remove CrystalCandidate
tag @e[type=minecraft:armor_stand,tag=NewChosenCrystal] remove NewChosenCrystal

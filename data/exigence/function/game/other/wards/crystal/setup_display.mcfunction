...
execute at @s[tag=Emerald] run summon minecraft:item_display ~ ~0.5 ~ {interpolation_duration:20,CustomName:{text:"ItemDisplay | Emerald"},billboard:"fixed",item:{id:"minecraft:lime_stained_glass",count:1},Tags:["NewCrystalDisplay","CrystalDisplay","Emerald"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0.0f,0.0f,0.0f],scale:[1.0f,1.0f,1.0f]}}
execute at @s[tag=Sapphire] run summon minecraft:item_display ~ ~0.5 ~ {interpolation_duration:20,CustomName:{text:"ItemDisplay | Sapphire"},billboard:"fixed",item:{id:"minecraft:blue_stained_glass",count:1},Tags:["NewCrystalDisplay","CrystalDisplay","Sapphire"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0.0f,0.0f,0.0f],scale:[1.0f,1.0f,1.0f]}}
execute at @s[tag=Ruby] run summon minecraft:item_display ~ ~0.5 ~ {interpolation_duration:20,CustomName:{text:"ItemDisplay | Ruby"},billboard:"fixed",item:{id:"minecraft:red_stained_glass",count:1},Tags:["NewCrystalDisplay","CrystalDisplay","Ruby"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0.0f,0.0f,0.0f],scale:[1.0f,1.0f,1.0f]}}
execute at @s[tag=Topaz] run summon minecraft:item_display ~ ~0.5 ~ {interpolation_duration:20,CustomName:{text:"ItemDisplay | Topaz"},billboard:"fixed",item:{id:"minecraft:yellow_stained_glass",count:1},Tags:["NewCrystalDisplay","CrystalDisplay","Topaz"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0.0f,0.0f,0.0f],scale:[1.0f,1.0f,1.0f]}}

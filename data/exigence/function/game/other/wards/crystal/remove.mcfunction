...
execute at @s as @e[type=minecraft:item_display,tag=CrystalDisplay,distance=..5] if score @s game.story.ward_crystal.node_id = #compare game.story.ward_crystal.node_id run kill @s

...
execute if score seconds.cooldown tick_counter matches 1 as @e[type=minecraft:item_display,tag=CrystalDisplay] at @s if entity @a[tag=ActivePlayer,distance=..24] run function exigence:game/other/wards/crystal/animate/new_frame

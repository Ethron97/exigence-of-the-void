...
# DEBUG
execute if score toggle.void debug matches 1 if score debug.level debug matches 4.. run say (D4 Void) Load 5
...
execute at @s positioned ^0.3 ^1.2 ^1 rotated ~ 0 run function exigence:game/other/void_shop/load/load_macro with storage exigence:void_shop
...
execute at @s positioned ^0.5 ^1.7 ^1 rotated ~ 0 run function exigence:game/other/void_shop/load/load_macro with storage exigence:void_shop
...
execute at @s positioned ^ ^2 ^1 rotated ~ 0 run function exigence:game/other/void_shop/load/load_macro with storage exigence:void_shop

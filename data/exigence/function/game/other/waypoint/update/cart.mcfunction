...
execute if score toggle.game debug matches 1 if score debug.level debug matches 4.. run say (D4) Updating waypoint CART

# If player on level, color white
execute if score #active_on_same Temp matches 1 run waypoint modify @s color gold

...
execute if score seconds.cooldown tick_counter matches 0 if score menace.queue game.dungeon.temp matches 1.. run function exigence:menace/resolve_menace

...
execute if score ravager.aggro.cooldown tick_counter matches 1 at @a[tag=ActivePlayer,scores={dead=0}] positioned ~ ~5 ~ run function exigence:menace/eyeball/flyball

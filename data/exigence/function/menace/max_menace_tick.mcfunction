...
execute if score ravager.aggro.cooldown tick_counter matches 1 at @a[scores={dead=0},tag=ActivePlayer] positioned ~ ~10 ~ run function exigence:menace/eyeball/flyball

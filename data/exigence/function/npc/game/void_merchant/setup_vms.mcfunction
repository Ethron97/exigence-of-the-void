...
execute if score mod.void_merchants game.modifiers matches 3.. run function exigence:npc/game/void_merchant/spawn {block:'minecraft:barrel'}
execute if score mod.void_merchants game.modifiers matches 4.. run function exigence:npc/game/void_merchant/spawn {block:'minecraft:cauldron'}

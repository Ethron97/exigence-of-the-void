...
execute if data storage exigence:dungeon {is_active:1} if score Chrysopoeia Modifiers matches 1 run scoreboard players add @s profile.data.treasure.cr.coinpickup_chrysopoeia 1

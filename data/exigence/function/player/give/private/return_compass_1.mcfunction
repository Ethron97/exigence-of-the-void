data modify storage exigence:compass x set value -278
data modify storage exigence:compass y set value 1
data modify storage exigence:compass z set value -120

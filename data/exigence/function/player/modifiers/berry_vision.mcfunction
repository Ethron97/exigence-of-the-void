...
execute as @e[type=minecraft:armor_stand,tag=BerryNode,tag=BerryGlowing] at @s unless entity @a[tag=ActivePlayer,scores={dead=0,mod_BerryVision=1},distance=..16] run function exigence:botany/node/unglow

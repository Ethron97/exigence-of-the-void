...
execute at @s as @e[type=minecraft:marker,tag=HiddenBlock,tag=ReflectionNO,tag=!Revealed,tag=!Appeared,distance=..5,sort=random,limit=1] at @s run function exigence:mirror/hidden_blocks/reveal_block

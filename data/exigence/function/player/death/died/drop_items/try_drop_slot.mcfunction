...
$execute if items entity @s $(slot_name) #exigence:trim_templates run return run execute unless score @s game.player.mod.vault_keep matches 1.. run function exigence:player/drop/drop_slot_specific {slot_name:'$(slot_name)'}
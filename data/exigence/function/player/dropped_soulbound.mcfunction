...
# Set owner
execute at @s on origin run data modify entity @n[type=minecraft:item,tag=DroppedSoulbounding,distance=..0.1] Owner set from entity @s UUID
...
execute at @s on origin run tp @n[type=minecraft:item,tag=DroppedSoulbounding,distance=..0.1] @s

...
execute if score et.FromCard game.effect_temp matches 1 if score @s game.player.mod.flicker matches 2 run scoreboard players add et.BonusTime game.effect_temp 300
execute if score et.FromCard game.effect_temp matches 1 if score @s game.player.mod.flicker matches 3 run scoreboard players add et.BonusTime game.effect_temp 600
execute if score et.FromCard game.effect_temp matches 1 if score @s game.player.mod.flicker matches 4 run scoreboard players add et.BonusTime game.effect_temp 1200
...
execute if score et.FromCard game.effect_temp matches 1 if score #temp game.effect_temp matches 1.. run tellraw @s [{text:" └─ [",color:"gray"},{text:"Bonus Effects",color:"green"},{text:"]: +",color:"gray"},{score:{name:"#temp",objective:"game.effect_temp"},color:"gray"},{text:" seconds of ",color:"gray"},{text:"Flicker",color:"yellow"}]

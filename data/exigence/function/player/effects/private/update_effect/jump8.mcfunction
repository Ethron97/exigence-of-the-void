...
scoreboard players operation @s effect_jump8 += AddingTime EffectTemp

# Cap time (if set)
scoreboard players operation @s effect_jump8 > SetTime EffectTemp

# Give player effect
execute store result storage exigence:player_effects duration int 0.05 run scoreboard players get @s effect_jump8

...
execute if score et.FromCard game.effect_temp matches 1 if score @s game.player.mod.beast_vision matches 7 run scoreboard players add et.AddingTime game.effect_temp 600

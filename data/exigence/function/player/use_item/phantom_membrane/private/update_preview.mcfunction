...
execute if score @s game.player.active_level matches 1 at @s positioned ^ ^ ^30 at @e[type=minecraft:armor_stand,scores={ObjectLevel=1},tag=PhantomNode,distance=..25,sort=nearest,limit=1] as @e[type=block_display,tag=ItemPreview,tag=Updating] run function exigence:player/use_item/phantom_membrane/private/teleport_preview
execute if score @s game.player.active_level matches 2 at @s positioned ^ ^ ^30 at @e[type=minecraft:armor_stand,scores={ObjectLevel=2},tag=PhantomNode,distance=..25,sort=nearest,limit=1] as @e[type=block_display,tag=ItemPreview,tag=Updating] run function exigence:player/use_item/phantom_membrane/private/teleport_preview
execute if score @s game.player.active_level matches 3 at @s positioned ^ ^ ^30 at @e[type=minecraft:armor_stand,scores={ObjectLevel=3},tag=PhantomNode,distance=..25,sort=nearest,limit=1] as @e[type=block_display,tag=ItemPreview,tag=Updating] run function exigence:player/use_item/phantom_membrane/private/teleport_preview
execute if score @s game.player.active_level matches 4 at @s positioned ^ ^ ^30 at @e[type=minecraft:armor_stand,scores={ObjectLevel=4},tag=PhantomNode,distance=..25,sort=nearest,limit=1] as @e[type=block_display,tag=ItemPreview,tag=Updating] run function exigence:player/use_item/phantom_membrane/private/teleport_preview

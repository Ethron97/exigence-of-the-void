# Generate a single key on the level of this player

## CONSTRAINTS
#   AS random active player

#====================================================================================================

execute if score toggle.vault debug matches 1 if score debug.level debug matches 3.. run say (D3) Dropping vault key
...
execute if score @s game.player.active_level matches 1 if score game.difficulty game.state matches 1.. as @e[x=-271,y=-55,z=-113,dx=-118,dy=92,dz=-153,type=minecraft:marker\
...
execute if score @s game.player.active_level matches 2 if score game.difficulty game.state matches 2.. as @e[x=-366,y=13,z=-106,dx=-118,dy=107,dz=-178,type=minecraft:marker\
...
execute if score @s game.player.active_level matches 3 if score game.difficulty game.state matches 3.. as @e[x=-306,y=113,z=33,dx=-168,dy=60,dz=-132,type=minecraft:marker\
...
execute if score @s game.player.active_level matches 4 if score game.difficulty game.state matches 4.. as @e[x=-306,y=113,z=33,dx=-168,dy=60,dz=-132,type=minecraft:marker\

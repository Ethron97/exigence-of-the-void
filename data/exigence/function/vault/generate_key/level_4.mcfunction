...
execute as @e[type=minecraft:armor_stand,scores={node.property.object_level=4},tag=TreasureNode,tag=!KeyBlacklist,sort=random,limit=1] run tag @s add VaultKeyDropper

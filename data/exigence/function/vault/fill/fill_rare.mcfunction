...
execute as @s[scores={Random=1,RandomB=..8}] at @s run function exigence:vault/fill/random_item_rare
execute as @s[scores={Random=1,RandomB=9..}] at @s run function exigence:vault/fill/random_item_legendary

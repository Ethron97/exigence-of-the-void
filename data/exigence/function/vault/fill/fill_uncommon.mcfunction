...
# If item, 10% chance to be rare
execute as @s[scores={Random=1,RandomB=..9}] at @s run function exigence:vault/fill/random_item_uncommon
execute as @s[scores={Random=1,RandomB=10}] at @s run function exigence:vault/fill/random_item_rare

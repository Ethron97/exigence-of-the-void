...
# If item, 10% chance to be uncommon
execute as @s[scores={Random=1,RandomB=..9}] at @s run function exigence:vault/fill/random_item_common
execute as @s[scores={Random=1,RandomB=10}] at @s run function exigence:vault/fill/random_item_uncommon

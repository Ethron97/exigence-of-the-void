...
execute if score toggle.vault debug matches 1 if score debug.level debug matches 4.. run say (D4 Vault) Fill (legendary)
...
execute as @s[scores={Random=1,RandomB=..7}] run function exigence:vault/pot/fill/random_item_legendary
execute as @s[scores={Random=1,RandomB=8..}] run function exigence:vault/pot/fill/random_item_void

...
$tellraw @s [{text:"Error: Found more than 1 copy of ",color:"red"},{text:"$(display_name)",color:"light_purple",bold:false},{text:"",color:"red"}]

$data modify storage exigence:deck_analysis errors append value [{text:"Error: Found more than 1 copy of ",color:"red"},{text:"$(display_name)",color:"light_purple",bold:false},{text:"",color:"red"}]
...
run tellraw @s [{text:"Error: Found more than 1 copy of ",color:"red"},{text:"$(display_name)",color:"light_purple",bold:false},{text:"",color:"red"}]
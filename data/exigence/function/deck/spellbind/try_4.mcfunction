...
execute positioned -302.42 2.00 -104.47 as @e[distance=..24,type=minecraft:armor_stand,tag=Card,scores={Deck=1..,deck.card.rarity=4},tag=!Played,tag=!Spellbound,tag=!Spellbinder,tag=!Instant,limit=1,sort=random] run function exigence:cards/spellbind

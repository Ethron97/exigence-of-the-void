...
execute positioned -302.42 2.00 -104.47 as @e[type=minecraft:armor_stand,scores={game.deck=1..,deck.card.rarity=2},tag=Card,tag=!Played,tag=!Spellbound,tag=!Spellbinder,tag=!Instant,distance=..24,sort=random,limit=1] run function exigence:cards/spellbind

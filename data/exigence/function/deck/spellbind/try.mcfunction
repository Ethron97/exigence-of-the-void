...
execute in minecraft:overworld as @e[x=537,y=-1,z=531,dx=4,dy=1,dz=10,type=minecraft:armor_stand,scores={game.deck=1..},tag=Card,tag=!Played,tag=!Spellbound,tag=!Spellbinder,tag=!Instant,sort=random,limit=1] run function exigence:cards/spellbind

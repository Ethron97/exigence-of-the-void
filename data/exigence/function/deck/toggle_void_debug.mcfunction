...
execute if score toggle.void debug matches 1 in exigence:hub run setblock 3 209 108 bamboo_wall_sign[facing=north]{front_text:{has_glowing_text:1b,color:"red",messages:["","VOID DEBUG","ON",""]}}
execute if score toggle.void debug matches 0 in exigence:hub run setblock 3 209 108 air

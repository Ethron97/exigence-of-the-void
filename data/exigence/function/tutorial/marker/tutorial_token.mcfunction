...
execute at @s as @e[type=item,distance=..2,nbt={Item:{id:"minecraft:flow_banner_pattern"}}] run team join Green @s
execute at @s as @e[type=item,distance=..2,nbt={Item:{id:"minecraft:flow_banner_pattern"}}] run data merge entity @s {Age:-32768,Glowing:true}

...
#execute as @a[distance=..1000,tag=Tutorial,scores={CarrotOnStick=1..}] run function exigence:tutorial/access/leave_tutorial
execute as @a[distance=..1000,tag=Tutorial,scores={CarrotOnStick=1..}] run function exigence:tutorial/access/use_item
...
give @a[distance=..1000,tag=Tutorial,nbt=!{Inventory:[{id:"minecraft:carrot_on_a_stick",components:{"minecraft:custom_data":{"item_name":'exit_tutorial'}}}]}] minecraft:carrot_on_a_stick[custom_name=[{text:"Exit Tutorial",color:"red",italic:false}],custom_data={item_name:'exit_tutorial'}]
give @a[distance=..1000,tag=Tutorial,nbt=!{Inventory:[{id:"minecraft:carrot_on_a_stick",components:{"minecraft:custom_data":{"item_name":'skip_section'}}}]}] minecraft:carrot_on_a_stick[custom_name=[{text:"Skip Section",color:"yellow",italic:false}],custom_data={item_name:'skip_section'}]
...
,{text:"   [",color:"dark_aqua"},{text:"❂❂",color:"aqua"},{text:"]",color:"dark_aqua"}]
execute if score Step Tutorial matches 1302.. run title @a[tag=Tutorial] actionbar [{text:"[",color:"green"},{text:"❂",color:"dark_green"},{text:"❂",color:"dark_gray"},{text:"]",color:"green"}\
,{text:"   [",color:"red"},{text:"",color:"dark_red"},{text:"❂❂",color:"dark_gray"},{text:"]",color:"red"}\
,{text:"   [",color:"dark_aqua"},{text:"❂❂",color:"aqua"},{text:"]",color:"dark_aqua"}]

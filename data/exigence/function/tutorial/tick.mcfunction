...
execute if score Step Tutorial matches 1102.. run title @a[tag=Tutorial] actionbar [{text:"[",color:"green"},{text:"❂",color:"dark_green"},{text:"❂",color:"dark_gray"},{text:"]",color:"green"}\
,{text:"   [",color:"dark_aqua"},{text:"❂❂",color:"aqua"},{text:"]",color:"dark_aqua"}]

...
execute in exigence:tutorial at @n[type=minecraft:marker,tag=TutorialMarker,tag=LastDropped,distance=..1000] \
...
execute in exigence:tutorial unless entity @e[type=minecraft:marker,tag=TutorialMarker,tag=LastDropped,distance=..1000] \
at @n[type=minecraft:marker,scores={TutorialMarkerID=6},tag=TutorialMarker,distance=..1000] \
as @n[type=minecraft:marker,tag=TutorialMarker,tag=!Dropped,distance=..100] run function exigence:tutorial/marker/tutorial_token

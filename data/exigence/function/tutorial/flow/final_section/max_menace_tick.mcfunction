...
execute if score RavagerAggroCooldownCurrent Tutorial matches 1 at @a[tag=Tutorial,distance=..1000] positioned ~ ~5 ~ run function exigence:tutorial/flow/final_section/summon_eyeball

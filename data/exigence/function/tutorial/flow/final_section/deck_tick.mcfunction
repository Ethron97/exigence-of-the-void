...
tellraw @a[tag=Tutorial,distance=..1000] [{text:"[",color:"white"},{text:"Deck empty - Drawing Fatigue",color:"gray"},{text:"]",color:"white"},{text:" + Menace",color:"dark_purple"}]
execute at @a[tag=Tutorial,distance=..1000] run playsound entity.allay.item_taken weather @a ~ ~1000 ~ 1000 1

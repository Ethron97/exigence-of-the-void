...
execute unless entity @p[distance=..1000,tag=Tutorial] run say Called tutorial.step without in exigence:tutorial, cancelling
execute unless entity @p[distance=..1000,tag=Tutorial] run return 1
#----------------------------------------------------------------------------------------------------

scoreboard players add Step Tutorial 1

# Playsound click
execute at @p[distance=..1000,tag=Tutorial] run playsound minecraft:ui.button.click ambient @s ~ ~1000 ~ 1000 1
...
execute if score Step Tutorial matches 1 as @p[distance=..1000,tag=Tutorial] run playsound minecraft:ui.toast.in ambient @s ~ ~1000 ~ 1000 1

## INTRODUCTION 
execute if score Step Tutorial matches 1 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"-> Welcome to the Tutorial Canyon!"}]
execute if score Step Tutorial matches 1 run bossbar set exigence:tutorial value 0

execute if score Step Tutorial matches 2 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Follow the Tutorial Tokens to learn how the dungeon operates."}]
execute if score Step Tutorial matches 2 run bossbar set exigence:tutorial value 1

execute if score Step Tutorial matches 3 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> The text at the top of your screen lists your current objective, as well as your overall progress."}]
...
execute if score Step Tutorial matches 102 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Here's one now. It appears to be too tall to fit through the hole."}]
...
execute if score Step Tutorial matches 103 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> See if you can find a way around the ravager."}]

execute if score Step Tutorial matches 104 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> The exit is blocked! Distract the ravager while the door melts!"}]
...
execute if score Step Tutorial matches 105 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> The exit is open, go go go!"}]
...
execute if score Step Tutorial matches 107 as @p[distance=..1000,tag=Tutorial] run playsound minecraft:ui.toast.in ambient @s ~ ~1000 ~ 1000 1

execute if score Step Tutorial matches 108 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Every 30 seconds, a random card will automatically be drawn and played."}]
execute if score Step Tutorial matches 108 run scoreboard players set Step Tutorial 200

execute if score Step Tutorial matches 201 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Sounds like a card just played!"}]
execute if score Step Tutorial matches 201 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"white",text:"["},{color:"dark_aqua",text:"Green Thumb"},{color:"white",text:"] "},{color:"white",text:"+ Berry Bushes"}]
execute if score Step Tutorial matches 201 as @p[distance=..1000,tag=Tutorial] run playsound minecraft:entity.lightning_bolt.thunder ambient @s ~ ~1000 ~ 1000 1
...
execute if score Step Tutorial matches 202 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Dead bushes cannot grow berries. See if you can find some other bushes."}]
...
# Pick first
execute if score Step Tutorial matches 203 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Each bush has a random chance to be grown at the start of each run."}]
execute if score Step Tutorial matches 203 run bossbar set exigence:tutorial value 33

# Pick second
execute if score Step Tutorial matches 204 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Bushes do not grow back on their own, but playing 🍒 cards can regrow them."}]
execute if score Step Tutorial matches 204 run bossbar set exigence:tutorial value 66
# Pick third
execute if score Step Tutorial matches 205 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Picking berry bushes also gives ❂ Green, which is used to power certain cards."}]
execute if score Step Tutorial matches 205 run title @p[distance=..1000,tag=Tutorial] subtitle [{text:"❂",color:"dark_green"}]
execute if score Step Tutorial matches 205 run title @p[distance=..1000,tag=Tutorial] title [{text:""}]
execute if score Step Tutorial matches 205 as @p[distance=..1000,tag=Tutorial] run playsound minecraft:ui.toast.in ambient @s ~ ~1000 ~ 1000 1
...
execute if score Step Tutorial matches 301 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> See that? That there is sculk."}]

execute if score Step Tutorial matches 302 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> It is one of the many long arms of the Watchers."}]
execute if score Step Tutorial matches 303 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> When sculk blocks a passage, it is called Hazard."}]
execute if score Step Tutorial matches 304 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Hazard can make traversing the dungeon more difficult."}]
execute if score Step Tutorial matches 305 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> However, there is ALWAYS at least one path through."}]

execute if score Step Tutorial matches 306 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> As you traverse the dungeon, you will generate Menace."}]
execute if score Step Tutorial matches 307 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Menace measures how aware the dungeon is of you."}]
execute if score Step Tutorial matches 308 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> The more Menace, the faster the heart of the Watchers will beat."}]


execute if score Step Tutorial matches 309 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> If you reach Max Menace, the Watchers become fully aware of you and there is no hiding."}]

execute if score Step Tutorial matches 310 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Hear that noise? The Watchers can sense your vibrations when you step on sculk."}]
execute if score Step Tutorial matches 310..311 run function exigence:tutorial/flow/next_token
execute if score Step Tutorial matches 311 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Stepping on sculk has a high chance of generating Menace."}]
execute if score Step Tutorial matches 311 run scoreboard players set Step Tutorial 315

#execute if score Step Tutorial matches 312 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Listen to the heartbeat as Menace increases by playing these samples."}]
...
execute if score Step Tutorial matches 401 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> The dungeon contains various treasures."}]

execute if score Step Tutorial matches 402 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Coins are the most common treasure drop."}]

execute if score Step Tutorial matches 403 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> They are converted into Glint when you leave the dungeon. Glint is used to purchase items from the shop."}]
execute if score Step Tutorial matches 403 run scoreboard players set Step Tutorial 702

execute if score Step Tutorial matches 703 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> See what you can find in this abandoned village."}]
...
execute if score Step Tutorial matches 801 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Sounds like a card just spawned some Ancient Embers."}]
execute if score Step Tutorial matches 801 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"white",text:"["},{color:"dark_aqua",text:"Ember Seeker"},{color:"white",text:"] "},{color:"white",text:"+ Ancient Embers"}]
...
{text:"▌▌▌",color:"white",italic:false},{text:"▌▌",color:"dark_gray",italic:false},{text:" ]",color:"white"}]
execute if score Step Tutorial matches 801 as @p[distance=..1000,tag=Tutorial] run playsound minecraft:entity.lightning_bolt.thunder ambient @s ~ ~1000 ~ 1000 1
...
execute if score Step Tutorial matches 802 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Unlike coins, Embers only spawn from cards and around Echo Shards."}]
execute if score Step Tutorial matches 802 run bossbar set exigence:tutorial value 33

execute if score Step Tutorial matches 803 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Embers can be spent purchasing cards after the run."}]
...
execute if score Step Tutorial matches 901 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> The final common dungeon drop is the Research Fragment."}]
...
execute if score Step Tutorial matches 901 run execute at @p[distance=..1000,tag=Tutorial] as @e[distance=5..1000,type=minecraft:armor_stand,tag=TreasureNode,scores={ObjectLevel=10},limit=2,sort=random] run function exigence:treasure/node/drop_treasure {priority:0,function:"exigence:treasure/sherd/summon_sherd"}
...
execute if score Step Tutorial matches 902 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Fragments are used to unlock new items in the shop."}]
...
execute if score Step Tutorial matches 1001 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Watch your step!"}]
execute if score Step Tutorial matches 1001 run function exigence:tutorial/flow/next_token

execute if score Step Tutorial matches 1002 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Up ahead is an old altar. Rekindle it by right clicking."}]
...
execute if score Step Tutorial matches 1003 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Now Enhance the altar by lighting it with an Ember."}]
...
execute if score Step Tutorial matches 1003 as @p[distance=..1000,tag=Tutorial] run function exigence:tutorial/flow/private/force_ember
execute if score Step Tutorial matches 1003 run title @p[distance=..1000,tag=Tutorial] subtitle [{text:"❂",color:"aqua"}]
execute if score Step Tutorial matches 1003 run title @p[distance=..1000,tag=Tutorial] title [{text:""}]

execute if score Step Tutorial matches 1004 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Lighting or Enhacing altars reduces Menace by 1, as well as giving ❂ Aqua."}]
execute if score Step Tutorial matches 1004 run title @p[distance=..1000,tag=Tutorial] subtitle [{text:"❂",color:"aqua"}]
execute if score Step Tutorial matches 1004 run title @p[distance=..1000,tag=Tutorial] title [{text:""}]
...
execute if score Step Tutorial matches 1101 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Some cards require ❂ Resources to play."}]

execute if score Step Tutorial matches 1101..1102 run function exigence:tutorial/flow/next_token

execute if score Step Tutorial matches 1102 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Beast Sense reveals nearby ravagers."}]
execute if score Step Tutorial matches 1102 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"white",text:"["},{color:"dark_aqua",text:"Beast Sense"},{color:"white",text:"] "},{color:"white",text:"1 Green: + Beast Sense"}]
...
{text:"▌▌",color:"white",italic:false},{text:"▌▌▌",color:"dark_gray",italic:false},{text:" ]",color:"white"}]
execute if score Step Tutorial matches 1102 as @p[distance=..1000,tag=Tutorial] run playsound minecraft:entity.lightning_bolt.thunder ambient @s ~ ~1000 ~ 1000 1
execute if score Step Tutorial matches 1102 run title @p[distance=..1000,tag=Tutorial] subtitle [{text:"✔",color:"dark_green"}]
execute if score Step Tutorial matches 1102 run title @p[distance=..1000,tag=Tutorial] title [{text:""}]
...
execute if score Step Tutorial matches 1102 run effect give @p[distance=..1000,tag=Tutorial] luck infinite 0

execute if score Step Tutorial matches 1103 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Ravagers may be slower than you, but they can climb up 2 block high steps."}]
...
## BELL / VARIANCE
#====================================================================================================
execute if score Step Tutorial matches 1201 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> The third and final ❂ resource is Red."}]
...
execute if score Step Tutorial matches 1201 run effect clear @p[distance=..1000,tag=Tutorial] luck

execute if score Step Tutorial matches 1202 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Ringing bells gives 1 Red, but has a 2/3 chance to trigger a Hazard."}]
...
# Ring the bell
execute if score Step Tutorial matches 1203 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Placeholder to explain how bells respawn/move after ringing them."}]
execute if score Step Tutorial matches 1203 run title @p[distance=..1000,tag=Tutorial] subtitle [{text:"❂",color:"dark_red"}]
execute if score Step Tutorial matches 1203 run title @p[distance=..1000,tag=Tutorial] title [{text:""}]
...
#====================================================================================================
execute if score Step Tutorial matches 1301 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Some shortcuts require Jump Boost."}]
execute if score Step Tutorial matches 1301..1304 run function exigence:tutorial/flow/next_token

execute if score Step Tutorial matches 1302 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Use your Jump Boost to take this shortcut."}]
execute if score Step Tutorial matches 1302 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"white",text:"["},{color:"green",text:"Quick Leap"},{color:"white",text:"] "},{color:"white",text:"1 Red: + Jump Boost II"}]
...
{text:"▌",color:"white",italic:false},{text:"▌▌▌▌",color:"dark_gray",italic:false},{text:" ]",color:"white"}]
execute if score Step Tutorial matches 1302 run title @p[distance=..1000,tag=Tutorial] subtitle [{text:"✔",color:"dark_red"}]
execute if score Step Tutorial matches 1302 run title @p[distance=..1000,tag=Tutorial] title [{text:""}]
execute if score Step Tutorial matches 1302 as @p[distance=..1000,tag=Tutorial] run playsound minecraft:entity.lightning_bolt.thunder ambient @s ~ ~1000 ~ 1000 1
execute if score Step Tutorial matches 1302 run effect give @p[distance=..1000,tag=Tutorial] jump_boost infinite 1
execute if score Step Tutorial matches 1302 run fill 136 126 140 137 126 142 ice replace structure_void

execute if score Step Tutorial matches 1303 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> There is one final aspect of the dungeon to learn about: Ravager Glass™"}]
execute if score Step Tutorial matches 1303 run effect clear @p[distance=..1000,tag=Tutorial] jump_boost
execute if score Step Tutorial matches 1303 run setblock 157 128 112 stone_bricks

execute if score Step Tutorial matches 1304 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> It is designed to withstand heavy loads..."}]
...
execute if score Step Tutorial matches 1308 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Here is an example of one such case."}]
# RELEASE RAVAGER
...
## JUMP BOOST / RAVAGER GLASS
#====================================================================================================
execute if score Step Tutorial matches 1401 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> If you don't have the required resources when a card is drawn, the card still plays but you do not get the effect."}]
execute if score Step Tutorial matches 1401 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"white",text:"["},{color:"green",text:"Quick Leap"},{color:"white",text:"] "},{color:"white",text:"1 Red: + Jump Boost II"}]
...
{text:"",color:"white",italic:false},{text:"▌▌▌▌▌",color:"dark_gray",italic:false},{text:" ]",color:"white"}]
execute if score Step Tutorial matches 1401 run title @p[distance=..1000,tag=Tutorial] subtitle [{text:"✖",color:"dark_red"}]
execute if score Step Tutorial matches 1401 run title @p[distance=..1000,tag=Tutorial] title [{text:""}]
execute if score Step Tutorial matches 1401 as @p[distance=..1000,tag=Tutorial] run playsound minecraft:entity.lightning_bolt.thunder ambient @s ~ ~1000 ~ 1000 1
...
execute if score Step Tutorial matches 1402 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> You are approaching the final test."}]

execute if score Step Tutorial matches 1403 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Each time you enter the dungeon, your primary objective is to retrieve the Echo Shard."}]

execute if score Step Tutorial matches 1404 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Not only is it needed to escape, but it always contains a cache of Ancient Embers near it."}]

execute if score Step Tutorial matches 1405 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> The deeper into the dungeon you go, the more treasure and embers you will find."}]

execute if score Step Tutorial matches 1406 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> We've simulated part of the dungeon up ahead. Are you ready?"}]
...
execute if score Step Tutorial matches 1501 run tellraw @p[distance=..1000,tag=Tutorial] [{color:"green",text:"\n-> Find the Echo Shard and bring it to the Exit Portal."}]
...
execute if score Step Tutorial matches 1501 run effect clear @p[distance=..1000,tag=Tutorial]

# Next trigger when the player picks up the echo shard
execute if score Step Tutorial matches 1502 run clear @p[distance=..1000,tag=Tutorial] compass
...
execute if score Step Tutorial matches 1502 at @p[distance=..1000,tag=Tutorial] run playsound minecraft:entity.wither.spawn neutral @p[distance=..1000,tag=Tutorial] ~ ~1000 ~ 1000 0.8
execute if score Step Tutorial matches 1502 run title @p[distance=..1000,tag=Tutorial] subtitle [{text:"❂",color:"dark_red"}]
...
execute if score Step Tutorial matches 1502 as @p[distance=..1000,tag=Tutorial] run function exigence:player/give/echo_shard

...
$execute if items entity @s[advancements={exigence:story/win_difficulty_0=true}] weapon.$(slot) carrot_on_a_stick[custom_data~{item_name:'exit_tutorial'}] run function exigence:tutorial/access/leave

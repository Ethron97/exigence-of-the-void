...
execute in exigence:tutorial run effect give @n[distance=..1000,type=minecraft:ravager,tag=L10,name=!Finaly] slowness infinite 100 true
...
execute in exigence:tutorial run effect give @n[distance=..1000,type=minecraft:ravager,tag=L10,name=Finaly] slowness infinite 0 true
execute in exigence:tutorial run attribute @n[distance=..1000,type=minecraft:ravager,tag=L10,name=Finaly] follow_range base set 200
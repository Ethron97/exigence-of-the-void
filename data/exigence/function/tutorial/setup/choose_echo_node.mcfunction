...
execute as @n[type=minecraft:armor_stand,tag=ChosenEchoNode,distance=..1000] run function exigence:tutorial/setup/echo_node/activate
...
# Drop embers
execute as @n[type=minecraft:armor_stand,tag=ChosenEchoNode,distance=..1000] at @s run function exigence:ember/echo_embers/drop_embers

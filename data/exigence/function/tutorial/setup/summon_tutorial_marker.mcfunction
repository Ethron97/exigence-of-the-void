...
scoreboard players operation @n[type=marker,tag=NewMarker,distance=..1] TutorialMarkerID = _next TutorialMarkerID

execute if data storage exigence:debug {tutorial:1} as @n[type=marker,tag=NewMarker,distance=..1] run function exigence:tutorial/marker/show
